      ...
      if (elem.shouldRemap()) {
         ...
         if (obfData.isEmpty()) {
            ...
            try {
               ...
               elem.printMessage(this.ap, Kind.ERROR, "Mapping conflict for @Accessor target " + elem + ": " + ex.getNew() + " for target " + target + " conflicts with existing mapping " + ex.getOld());
            }
      ...
      if (elem.shouldRemap()) {
         ...
         if (obfData.isEmpty()) {
            ...
            try {
               ...
               elem.printMessage(this.ap, Kind.ERROR, "Mapping conflict for @Invoker target " + elem + ": " + ex.getNew() + " for target " + target + " conflicts with existing mapping " + ex.getOld());
            }
