...
public class JSONObject {
   ...
   public Enum getEnum(Class clazz, String key) throws JSONException {
      E val = (E)this.optEnum(clazz, key);
      if (val == null) {
   ...
   public JSONObject increment(String key) throws JSONException {
      ...
      if (value == null) {
         ...
         this.put(key, (Double)value + (double)1.0F);
      } else {
   ...
   public Enum optEnum(Class clazz, String key) {
      return this.optEnum(clazz, key, (Enum)null);
   }

   public Enum optEnum(Class clazz, String key, Enum defaultValue) {
      try {
