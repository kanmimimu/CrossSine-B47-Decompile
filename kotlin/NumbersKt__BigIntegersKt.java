...
class NumbersKt__BigIntegersKt extends NumbersKt__BigDecimalsKt {
   ...
   private static final BigInteger plus(BigInteger $this$plus, BigInteger other) {
      ...
      BigInteger var2 = $this$plus.add(other);
   ...
   private static final BigInteger minus(BigInteger $this$minus, BigInteger other) {
      ...
      Intrinsics.checkNotNullParameter(other, "other");
      BigInteger var2 = $this$minus.subtract(other);
   ...
   private static final BigInteger times(BigInteger $this$times, BigInteger other) {
      ...
      Intrinsics.checkNotNullParameter(other, "other");
      BigInteger var2 = $this$times.multiply(other);
   ...
   private static final BigInteger div(BigInteger $this$div, BigInteger other) {
      ...
      Intrinsics.checkNotNullParameter(other, "other");
      BigInteger var2 = $this$div.divide(other);
      Intrinsics.checkNotNullExpressionValue(var2, "this.divide(other)");
      return var2;
   }
   ...
   private static final BigInteger rem(BigInteger $this$rem, BigInteger other) {
      ...
      Intrinsics.checkNotNullParameter(other, "other");
      BigInteger var2 = $this$rem.remainder(other);
   ...
   private static final BigInteger unaryMinus(BigInteger $this$unaryMinus) {
      ...
      BigInteger var1 = $this$unaryMinus.negate();
   ...
   private static final BigInteger inc(BigInteger $this$inc) {
      ...
      BigInteger var1 = $this$inc.add(BigInteger.ONE);
      Intrinsics.checkNotNullExpressionValue(var1, "this.add(BigInteger.ONE)");
      return var1;
   }
   ...
   private static final BigInteger dec(BigInteger $this$dec) {
      ...
      BigInteger var1 = $this$dec.subtract(BigInteger.ONE);
      Intrinsics.checkNotNullExpressionValue(var1, "this.subtract(BigInteger.ONE)");
      return var1;
   }
   ...
   private static final BigInteger inv(BigInteger $this$inv) {
      ...
      BigInteger var1 = $this$inv.not();
      Intrinsics.checkNotNullExpressionValue(var1, "this.not()");
      return var1;
   }
   ...
   private static final BigInteger and(BigInteger $this$and, BigInteger other) {
      ...
      Intrinsics.checkNotNullParameter(other, "other");
      BigInteger var2 = $this$and.and(other);
      Intrinsics.checkNotNullExpressionValue(var2, "this.and(other)");
      return var2;
   }
   ...
   private static final BigInteger or(BigInteger $this$or, BigInteger other) {
      ...
      Intrinsics.checkNotNullParameter(other, "other");
      BigInteger var2 = $this$or.or(other);
      Intrinsics.checkNotNullExpressionValue(var2, "this.or(other)");
      return var2;
   }
   ...
   private static final BigInteger xor(BigInteger $this$xor, BigInteger other) {
      ...
      Intrinsics.checkNotNullParameter(other, "other");
      BigInteger var2 = $this$xor.xor(other);
      Intrinsics.checkNotNullExpressionValue(var2, "this.xor(other)");
      return var2;
   }
   ...
   private static final BigInteger shl(BigInteger $this$shl, int n) {
      ...
      BigInteger var2 = $this$shl.shiftLeft(n);
      Intrinsics.checkNotNullExpressionValue(var2, "this.shiftLeft(n)");
      return var2;
   }
   ...
   private static final BigInteger shr(BigInteger $this$shr, int n) {
      ...
      BigInteger var2 = $this$shr.shiftRight(n);
      Intrinsics.checkNotNullExpressionValue(var2, "this.shiftRight(n)");
      return var2;
   }
   ...
   private static final BigInteger toBigInteger(int $this$toBigInteger) {
      BigInteger var1 = BigInteger.valueOf((long)$this$toBigInteger);
   ...
   private static final BigInteger toBigInteger(long $this$toBigInteger) {
      BigInteger var2 = BigInteger.valueOf($this$toBigInteger);
   ...
   static BigDecimal toBigDecimal$default(BigInteger $this$toBigDecimal_u24default, int scale, MathContext mathContext, int var3, Object var4) {
      ...
      if ((var3 & 2) != 0) {
         MathContext var5 = MathContext.UNLIMITED;
         Intrinsics.checkNotNullExpressionValue(var5, "UNLIMITED");
         mathContext = var5;
      }
