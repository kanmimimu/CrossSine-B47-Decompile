...
public final class Delegates {
   ...
   @NotNull
   public final ReadWriteProperty observable(final Object initialValue, @NotNull final Function3 onChange) {
   ...
   @NotNull
   public final ReadWriteProperty vetoable(final Object initialValue, @NotNull final Function3 onChange) {
      Intrinsics.checkNotNullParameter(onChange, "onChange");
      int $i$f$vetoable = 0;
      return new ObservableProperty() {
