...
@Metadata(
   ...
   d2 = {"absoluteValue", "", "getAbsoluteValue$annotations", "(D)V", "getAbsoluteValue", "(D)D", "", "(F)V", "(F)F", "", "(I)V", "(I)I", "", "(J)V", "(J)J", "sign", "getSign$annotations", "getSign", "(J)I", "ulp", "getUlp$annotations", "getUlp", "abs", "x", "n", "acos", "acosh", "asin", "asinh", "atan", "atan2", "y", "atanh", "ceil", "cos", "cosh", "exp", "expm1", "floor", "hypot", "ln", "ln1p", "log", "base", "log10", "log2", "max", "a", "b", "min", "round", "sin", "sinh", "sqrt", "tan", "tanh", "truncate", "IEEErem", "divisor", "nextDown", "nextTowards", "to", "nextUp", "pow", "roundToInt", "roundToLong", "withSign", "kotlin-stdlib"},
...
class MathKt__MathJVMKt extends MathKt__MathHKt {
   ...
   @InlineOnly
   public static void getAbsoluteValue$annotations(double var0) {
   }
   ...
   @InlineOnly
   public static void getSign$annotations(double var0) {
   }
   ...
   @InlineOnly
   public static void getUlp$annotations(double var0) {
   }
   ...
   @InlineOnly
   public static void getAbsoluteValue$annotations(float var0) {
   }
   ...
   @InlineOnly
   public static void getSign$annotations(float var0) {
   }
   ...
   @InlineOnly
   public static void getUlp$annotations(float var0) {
   }
   ...
   @InlineOnly
   public static void getAbsoluteValue$annotations(int var0) {
   }
   ...
   public static void getSign$annotations(int var0) {
   }
   ...
   @InlineOnly
   public static void getAbsoluteValue$annotations(long var0) {
   }
   ...
   public static void getSign$annotations(long var0) {
   }
