...
public final class UnsignedKt {
   ...
   public static final int doubleToUInt(double v) {
      return Double.isNaN(v) ? 0 : (v <= uintToDouble(0) ? 0 : (v >= uintToDouble(-1) ? -1 : (v <= (double)Integer.MAX_VALUE ? UInt.constructor-impl((int)v) : UInt.constructor-impl(UInt.constructor-impl((int)(v - (double)Integer.MAX_VALUE)) + UInt.constructor-impl(Integer.MAX_VALUE)))));
   }

   @PublishedApi
   public static final long doubleToULong(double v) {
      return Double.isNaN(v) ? 0L : (v <= ulongToDouble(0L) ? 0L : (v >= ulongToDouble(-1L) ? -1L : (v < (double)Long.MAX_VALUE ? ULong.constructor-impl((long)v) : ULong.constructor-impl(ULong.constructor-impl((long)(v - (double)Long.MAX_VALUE)) + Long.MIN_VALUE))));
   }
