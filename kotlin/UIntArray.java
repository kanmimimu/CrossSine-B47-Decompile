...
public final class UIntArray implements Collection, KMappedMarker {
   ...
   public static int[] constructor_impl/* $FF was: constructor-impl*/(int size) {
      int[] var1 = constructor-impl(new int[size]);
      return var1;
   }
   ...
   public static boolean equals_impl/* $FF was: equals-impl*/(int[] arg0, Object other) {
      if (!(other instanceof UIntArray)) {
         ...
         int[] var2 = ((UIntArray)other).unbox-impl();
   ...
   @Metadata(
      ...
      d2 = {"Lkotlin/UIntArray$Iterator;", "Lkotlin/collections/UIntIterator;", "array", "", "([I)V", "index", "", "hasNext", "", "nextUInt", "Lkotlin/UInt;", "nextUInt-pVg5ArA", "()I", "kotlin-stdlib"}
   )
   private static final class Iterator extends UIntIterator {
      ...
      public int nextUInt_pVg5ArA/* $FF was: nextUInt-pVg5ArA*/() {
         if (this.index < this.array.length) {
            int[] var10000 = this.array;
            int var2 = this.index++;
            return UInt.constructor-impl(var10000[var2]);
         } else {
