...
public final class DropSequence implements Sequence, DropTakeSequence {
   ...
   public DropSequence(@NotNull Sequence sequence, int count) {
   ...
   public Sequence take(int n) {
      int n1 = this.count + n;
      int var4 = 0;
      return n1 < 0 ? (DropTakeSequence)(new TakeSequence(this, n)) : (DropTakeSequence)(new SubSequence(this.sequence, this.count, n1));
   }
