...
class SequencesKt__SequenceBuilderKt {
   ...
   @InlineOnly
   private static final Sequence buildSequence(@BuilderInference Function2 builderAction) {
      Intrinsics.checkNotNullParameter(builderAction, "builderAction");
      return new SequencesKt__SequenceBuilderKt$buildSequence$$inlined$Sequence$1(builderAction);
   }
   ...
   @InlineOnly
   private static final Iterator buildIterator(@BuilderInference Function2 builderAction) {
      Intrinsics.checkNotNullParameter(builderAction, "builderAction");
