...
@Metadata(
   ...
   d2 = {"filterIsInstance", "Lkotlin/sequences/Sequence;", "R", "klass", "Ljava/lang/Class;", "filterIsInstanceTo", "C", "", "destination", "(Lkotlin/sequences/Sequence;Ljava/util/Collection;Ljava/lang/Class;)Ljava/util/Collection;", "sumOf", "Ljava/math/BigDecimal;", "T", "selector", "Lkotlin/Function1;", "sumOfBigDecimal", "Ljava/math/BigInteger;", "sumOfBigInteger", "toSortedSet", "Ljava/util/SortedSet;", "", "comparator", "Ljava/util/Comparator;", "Lkotlin/Comparator;", "kotlin-stdlib"},
...
class SequencesKt___SequencesJvmKt extends SequencesKt__SequencesKt {
   ...
   public static final Sequence filterIsInstance(@NotNull Sequence $this$filterIsInstance, @NotNull final Class klass) {
      ...
      return SequencesKt.filter($this$filterIsInstance, new Function1() {
         @NotNull
   ...
   private static final BigDecimal sumOfBigDecimal(Sequence $this$sumOf, Function1 selector) {
      ...
      for(Object element : $this$sumOf) {
         BigDecimal var5 = sum.add((BigDecimal)selector.invoke(element));
   ...
   private static final BigInteger sumOfBigInteger(Sequence $this$sumOf, Function1 selector) {
      ...
      for(Object element : $this$sumOf) {
         BigInteger var5 = sum.add((BigInteger)selector.invoke(element));
         Intrinsics.checkNotNullExpressionValue(var5, "this.add(other)");
         sum = var5;
      }
