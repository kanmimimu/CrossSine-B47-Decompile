...
public final class FilePathComponents {
   ...
   public final File subPath(int beginIndex, int endIndex) {
      if (beginIndex >= 0 && beginIndex <= endIndex && endIndex <= this.getSize()) {
         ...
         return new File(CollectionsKt.joinToString$default(var10002, (CharSequence)var3, (CharSequence)null, (CharSequence)null, 0, (CharSequence)null, (Function1)null, 62, (Object)null));
      } else {
