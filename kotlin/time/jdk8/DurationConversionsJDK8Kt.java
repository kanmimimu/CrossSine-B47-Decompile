...
public final class DurationConversionsJDK8Kt {
   ...
   @InlineOnly
   private static final Duration toJavaDuration_LRDsOJo/* $FF was: toJavaDuration-LRDsOJo*/(long $this$toJavaDuration) {
      int var3 = 0;
      long var10000 = kotlin.time.Duration.getInWholeSeconds-impl($this$toJavaDuration);
      int nanoseconds = kotlin.time.Duration.getNanosecondsComponent-impl($this$toJavaDuration);
      long seconds = var10000;
      int var7 = 0;
      Duration var2 = Duration.ofSeconds(seconds, (long)nanoseconds);
