...
@Metadata(
   ...
   d2 = {"Lkotlin/time/AbstractLongTimeSource;", "Lkotlin/time/TimeSource;", "unit", "Lkotlin/time/DurationUnit;", "(Lkotlin/time/DurationUnit;)V", "getUnit", "()Lkotlin/time/DurationUnit;", "markNow", "Lkotlin/time/TimeMark;", "read", "", "LongTimeMark", "kotlin-stdlib"}
)
@SinceKotlin(
   version = "1.3"
)
...
public abstract class AbstractLongTimeSource implements TimeSource {
   ...
   public TimeMark markNow() {
      return new LongTimeMark(this.read(), this, Duration.Companion.getZERO-UwyO8pc(), (DefaultConstructorMarker)null);
   }
   ...
   private static final class LongTimeMark extends TimeMark {
      ...
      public TimeMark plus_LRDsOJo/* $FF was: plus-LRDsOJo*/(long duration) {
         return new LongTimeMark(this.startedAt, this.timeSource, Duration.plus-LRDsOJo(this.offset, duration), (DefaultConstructorMarker)null);
      }
