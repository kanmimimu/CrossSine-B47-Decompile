...
public final class UShortArray implements Collection, KMappedMarker {
   ...
   public static short[] constructor_impl/* $FF was: constructor-impl*/(int size) {
      short[] var1 = constructor-impl(new short[size]);
      return var1;
   }
   ...
   public static boolean equals_impl/* $FF was: equals-impl*/(short[] arg0, Object other) {
      if (!(other instanceof UShortArray)) {
         ...
         short[] var2 = ((UShortArray)other).unbox-impl();
   ...
   @Metadata(
      ...
      d2 = {"Lkotlin/UShortArray$Iterator;", "Lkotlin/collections/UShortIterator;", "array", "", "([S)V", "index", "", "hasNext", "", "nextUShort", "Lkotlin/UShort;", "nextUShort-Mh2AYeg", "()S", "kotlin-stdlib"}
   )
   private static final class Iterator extends UShortIterator {
      ...
      public short nextUShort_Mh2AYeg/* $FF was: nextUShort-Mh2AYeg*/() {
         if (this.index < this.array.length) {
            short[] var10000 = this.array;
            int var2 = this.index++;
            return UShort.constructor-impl(var10000[var2]);
         } else {
