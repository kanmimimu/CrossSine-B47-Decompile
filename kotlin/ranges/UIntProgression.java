...
@Metadata(
   ...
   d2 = {"Lkotlin/ranges/UIntProgression;", "", "Lkotlin/UInt;", "start", "endInclusive", "step", "", "(IIILkotlin/jvm/internal/DefaultConstructorMarker;)V", "first", "getFirst-pVg5ArA", "()I", "I", "last", "getLast-pVg5ArA", "getStep", "equals", "", "other", "", "hashCode", "isEmpty", "iterator", "", "toString", "", "Companion", "kotlin-stdlib"}
)
@SinceKotlin(
   version = "1.5"
)
...
public class UIntProgression implements Iterable, KMappedMarker {
   ...
   public final Iterator iterator() {
      return new UIntProgressionIterator(this.getFirst-pVg5ArA(), this.getLast-pVg5ArA(), this.step, (DefaultConstructorMarker)null);
   }
