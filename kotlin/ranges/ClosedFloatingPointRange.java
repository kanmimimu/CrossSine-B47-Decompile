...
public interface ClosedFloatingPointRange extends ClosedRange {
   ...
   public static final class DefaultImpls {
      public static boolean contains(@NotNull ClosedFloatingPointRange var0, @NotNull Comparable value) {
         Intrinsics.checkNotNullParameter(var0, "this");
         Intrinsics.checkNotNullParameter(value, "value");
         return var0.lessThanOrEquals(var0.getStart(), value) && var0.lessThanOrEquals(value, var0.getEndInclusive());
      }

      public static boolean isEmpty(@NotNull ClosedFloatingPointRange var0) {
         Intrinsics.checkNotNullParameter(var0, "this");
