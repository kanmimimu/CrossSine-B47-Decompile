...
public abstract class AbstractMap implements Map, KMappedMarker {
   ...
   public final boolean containsEntry$kotlin_stdlib(@Nullable Map.Entry entry) {
      if (entry == null) {
         ...
         Map var5 = this;
         Object ourValue = var5.get(key);
         if (!Intrinsics.areEqual(value, ourValue)) {
            return false;
         } else {
            if (ourValue == null) {
               var5 = this;
               if (!var5.containsKey(key)) {
                  return false;
               }
            }
   ...
   public Object get(Object key) {
      Map.Entry var2 = this.implFindEntry(key);
   ...
   public String toString() {
      return CollectionsKt.joinToString$default((Iterable)this.entrySet(), (CharSequence)", ", (CharSequence)"{", (CharSequence)"}", 0, (CharSequence)null, new Function1() {
         @NotNull
         public final CharSequence invoke(@NotNull Map.Entry it) {
            Intrinsics.checkNotNullParameter(it, "it");
            return (CharSequence)AbstractMap.this.toString(it);
         }
      }, 24, (Object)null);
   }
   ...
   public static final class Companion {
      ...
      public final int entryHashCode$kotlin_stdlib(@NotNull Map.Entry e) {
         ...
         int var3 = 0;
         Object var4 = e.getKey();
         int var10000 = var4 == null ? 0 : var4.hashCode();
         var4 = e.getValue();
         return var10000 ^ (var4 == null ? 0 : var4.hashCode());
      }
