...
class UCollectionsKt___UCollectionsKt {
   ...
   public static final byte[] toUByteArray(@NotNull Collection $this$toUByteArray) {
      ...
      while(var3.hasNext()) {
         ...
         int var5 = index++;
         UByteArray.set-VurrAj0(result, var5, element);
      }
   ...
   public static final int[] toUIntArray(@NotNull Collection $this$toUIntArray) {
      ...
      while(var3.hasNext()) {
         ...
         int var5 = index++;
         UIntArray.set-VXSXFK8(result, var5, element);
      }
   ...
   public static final long[] toULongArray(@NotNull Collection $this$toULongArray) {
      ...
      while(var3.hasNext()) {
         ...
         int var6 = index++;
         ULongArray.set-k8EXiF4(result, var6, element);
      }
   ...
   public static final short[] toUShortArray(@NotNull Collection $this$toUShortArray) {
      ...
      while(var3.hasNext()) {
         ...
         int var5 = index++;
         UShortArray.set-01HTLdE(result, var5, element);
      }
   ...
   public static final int sumOfUByte(@NotNull Iterable $this$sum) {
      ...
      int var4;
      for(Iterator var2 = $this$sum.iterator(); var2.hasNext(); sum = UInt.constructor-impl(sum + var4)) {
         byte element = ((UByte)var2.next()).unbox-impl();
         var4 = UInt.constructor-impl(element & 255);
      }
   ...
   public static final int sumOfUShort(@NotNull Iterable $this$sum) {
      ...
      for(Iterator var2 = $this$sum.iterator(); var2.hasNext(); sum = UInt.constructor-impl(sum + var4)) {
         ...
         var4 = UInt.constructor-impl(element & '\uffff');
      }
