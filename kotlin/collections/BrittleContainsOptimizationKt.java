...
public final class BrittleContainsOptimizationKt {
   private static final boolean safeToConvertToSet(Collection $this$safeToConvertToSet) {
   ...
   @NotNull
   public static final Collection convertToSetForSetOperationWith(@NotNull Iterable $this$convertToSetForSetOperationWith, @NotNull Iterable source) {
      ...
      if ($this$convertToSetForSetOperationWith instanceof Set) {
         ...
         var10000 = source instanceof Collection && ((Collection)source).size() < 2 ? (Collection)$this$convertToSetForSetOperationWith : (safeToConvertToSet((Collection)$this$convertToSetForSetOperationWith) ? (Collection)CollectionsKt.toHashSet($this$convertToSetForSetOperationWith) : (Collection)$this$convertToSetForSetOperationWith);
      } else {
         int $i$f$brittleContainsOptimizationEnabled = 0;
   ...
   @NotNull
   public static final Collection convertToSetForSetOperation(@NotNull Iterable $this$convertToSetForSetOperation) {
      ...
      if ($this$convertToSetForSetOperation instanceof Set) {
         ...
         var10000 = safeToConvertToSet((Collection)$this$convertToSetForSetOperation) ? (Collection)CollectionsKt.toHashSet($this$convertToSetForSetOperation) : (Collection)$this$convertToSetForSetOperation;
      } else {
         int $i$f$brittleContainsOptimizationEnabled = 0;
   ...
   @NotNull
   public static final Collection convertToSetForSetOperation(@NotNull Sequence $this$convertToSetForSetOperation) {
      Intrinsics.checkNotNullParameter($this$convertToSetForSetOperation, "<this>");
      int $i$f$brittleContainsOptimizationEnabled = 0;
   ...
   @NotNull
   public static final Collection convertToSetForSetOperation(@NotNull Object[] $this$convertToSetForSetOperation) {
      Intrinsics.checkNotNullParameter($this$convertToSetForSetOperation, "<this>");
      int $i$f$brittleContainsOptimizationEnabled = 0;
