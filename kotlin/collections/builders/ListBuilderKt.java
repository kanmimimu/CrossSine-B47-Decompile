...
public final class ListBuilderKt {
   ...
   private static final String subarrayContentToString(Object[] $this$subarrayContentToString, int offset, int length) {
   ...
   // $FF: synthetic method
   public static final String access$subarrayContentToString(Object[] $receiver, int offset, int length) {
      return subarrayContentToString($receiver, offset, length);
   }
