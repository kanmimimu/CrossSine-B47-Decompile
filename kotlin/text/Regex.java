...
public final class Regex implements Serializable {
   ...
   public Regex(@NotNull String pattern) {
      ...
      Pattern var2 = Pattern.compile(pattern);
   ...
   public Regex(@NotNull String pattern, @NotNull RegexOption option) {
      ...
      Pattern var3 = Pattern.compile(pattern, Companion.ensureUnicodeCase(option.getValue()));
   ...
   public Regex(@NotNull String pattern, @NotNull Set options) {
      ...
      Pattern var3 = Pattern.compile(pattern, Companion.ensureUnicodeCase(RegexKt.access$toInt((Iterable)options)));
   ...
   public final Set getOptions() {
      ...
      if (var1 == null) {
         ...
         CollectionsKt.retainAll((Iterable)$this$fromInt_u24lambda_u2d1$iv, new Regex$special$$inlined$fromInt$1(value$iv));
         Set it = Collections.unmodifiableSet((Set)$this$fromInt_u24lambda_u2d1$iv);
   ...
   public final MatchResult find(@NotNull CharSequence input, int startIndex) {
      Intrinsics.checkNotNullParameter(input, "input");
      Matcher var3 = this.nativePattern.matcher(input);
      Intrinsics.checkNotNullExpressionValue(var3, "nativePattern.matcher(input)");
      return RegexKt.access$findNext(var3, startIndex, input);
   }
   ...
   public final Sequence findAll(@NotNull final CharSequence input, final int startIndex) {
      ...
      if (startIndex >= 0 && startIndex <= input.length()) {
         return SequencesKt.generateSequence(new Function0() {
            @Nullable
   ...
   public final MatchResult matchEntire(@NotNull CharSequence input) {
      Intrinsics.checkNotNullParameter(input, "input");
      Matcher var2 = this.nativePattern.matcher(input);
      Intrinsics.checkNotNullExpressionValue(var2, "nativePattern.matcher(input)");
      return RegexKt.access$matchEntire(var2, input);
   }
   ...
   public final MatchResult matchAt(@NotNull CharSequence input, int index) {
      ...
      if ($this$matchAt_u24lambda_u2d1.lookingAt()) {
         ...
         var10000 = new MatcherMatchResult($this$matchAt_u24lambda_u2d1, input);
      } else {
         var10000 = null;
      }
   ...
   public final String replace(@NotNull CharSequence input, @NotNull String replacement) {
      ...
      String var3 = this.nativePattern.matcher(input).replaceAll(replacement);
   ...
   public final String replace(@NotNull CharSequence input, @NotNull Function1 transform) {
      ...
      MatchResult var4 = find$default(this, input, 0, 2, (Object)null);
      if (var4 == null) {
         return input.toString();
      } else {
         MatchResult match = var4;
         int lastStart = 0;
         ...
         String foundMatch = sb.toString();
         Intrinsics.checkNotNullExpressionValue(foundMatch, "sb.toString()");
         return foundMatch;
      }
   }
   ...
   public final String replaceFirst(@NotNull CharSequence input, @NotNull String replacement) {
      Intrinsics.checkNotNullParameter(input, "input");
      Intrinsics.checkNotNullParameter(replacement, "replacement");
      String var3 = this.nativePattern.matcher(input).replaceFirst(replacement);
   ...
   public final List split(@NotNull CharSequence input, int limit) {
      ...
      if (limit != 1 && matcher.find()) {
         ...
         do {
            int var8 = matcher.start();
            result.add(input.subSequence(lastStart, var8).toString());
            lastStart = matcher.end();
         } while((lastSplit < 0 || result.size() != lastSplit) && matcher.find());

         int var9 = input.length();
         result.add(input.subSequence(lastStart, var9).toString());
         return (List)result;
      } else {
         ...
         public final Object invokeSuspend(@NotNull Object $result) {
            ...
            switch (this.label) {
               case 0:
                  ...
                  if (limit == 1 || !matcher.find()) {
                     String var16 = input.toString();
                     Continuation var19 = this;
                     this.label = 1;
                     if ($this$sequence.yield(var16, var19) == var8) {
                        return var8;
                     }
                  ...
                  int nextStart = 0;
                  splitCount = 0;
                  CharSequence var6 = input;
                  int var7 = matcher.start();
                  String var10001 = var6.subSequence(nextStart, var7).toString();
            ...
            do {
               ...
               if (splitCount == limit - 1 || !matcher.find()) {
                  CharSequence var11 = input;
                  int var13 = input.length();
                  var14 = var11.subSequence(nextStart, var13).toString();
                  var17 = this;
                  this.L$0 = null;
                  this.L$1 = null;
                  this.label = 3;
                  if ($this$sequence.yield(var14, var17) == var8) {
                     return var8;
                  }
               ...
               CharSequence var10 = input;
               int var12 = matcher.start();
               var14 = var10.subSequence(nextStart, var12).toString();
               var17 = this;
               this.L$0 = $this$sequence;
               this.L$1 = matcher;
               this.I$0 = splitCount;
               this.label = 2;
            } while($this$sequence.yield(var14, var17) != var8);
   ...
   public static final class Companion {
      ...
      public final String escape(@NotNull String literal) {
         Intrinsics.checkNotNullParameter(literal, "literal");
         String var2 = Pattern.quote(literal);
         Intrinsics.checkNotNullExpressionValue(var2, "quote(literal)");
         return var2;
      }
      ...
      public final String escapeReplacement(@NotNull String literal) {
         Intrinsics.checkNotNullParameter(literal, "literal");
         String var2 = Matcher.quoteReplacement(literal);
         Intrinsics.checkNotNullExpressionValue(var2, "quoteReplacement(literal)");
         return var2;
      }
