...
class StringsKt__StringNumberConversionsKt extends StringsKt__StringNumberConversionsJVMKt {
   ...
   public static final Integer toIntOrNull(@NotNull String $this$toIntOrNull, int radix) {
      ...
      if (length == 0) {
         ...
         int digit;
         for(int var10 = start; var10 < length; result -= digit) {
            int i = var10++;
            digit = CharsKt.digitOf($this$toIntOrNull.charAt(i), radix);
            if (digit < 0) {
               return null;
            }
   ...
   public static final Long toLongOrNull(@NotNull String $this$toLongOrNull, int radix) {
      ...
      if (length == 0) {
         ...
         int digit;
         for(int var14 = start; var14 < length; result -= (long)digit) {
            int i = var14++;
            digit = CharsKt.digitOf($this$toLongOrNull.charAt(i), radix);
            if (digit < 0) {
               return null;
            }
