...
public final class PropertyReferenceDelegatesKt {
   ...
   @InlineOnly
   private static final Object getValue(KProperty0 $this$getValue, Object thisRef, KProperty property) {
   ...
   @InlineOnly
   private static final void setValue(KMutableProperty0 $this$setValue, Object thisRef, KProperty property, Object value) {
   ...
   @InlineOnly
   private static final Object getValue(KProperty1 $this$getValue, Object thisRef, KProperty property) {
      Intrinsics.checkNotNullParameter($this$getValue, "<this>");
      Intrinsics.checkNotNullParameter(property, "property");
   ...
   @InlineOnly
   private static final void setValue(KMutableProperty1 $this$setValue, Object thisRef, KProperty property, Object value) {
      Intrinsics.checkNotNullParameter($this$setValue, "<this>");
      Intrinsics.checkNotNullParameter(property, "property");
