...
public final class NashornScriptEngine extends AbstractScriptEngine implements Compilable, Invocable {
   ...
   NashornScriptEngine(NashornScriptEngineFactory factory, String[] args, final ClassLoader appLoader, final ClassFilter classFilter) {
      ...
      this.nashornContext = (Context)AccessController.doPrivileged(new PrivilegedAction() {
         public Context run() {
            try {
   ...
   private Object getInterfaceInner(Object thiz, Class clazz) {
            ...
            try {
               ...
               try {
                  ...
                  if (isInterfaceImplemented(clazz, realSelf)) {
                     var8 = clazz.cast(JavaAdapterFactory.getConstructor(realSelf.getClass(), clazz, MethodHandles.publicLookup()).invoke(realSelf));
                     return var8;
                  }
