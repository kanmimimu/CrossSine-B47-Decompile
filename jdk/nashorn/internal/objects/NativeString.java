...
public final class NativeString extends ScriptObject implements OptimisticBuiltins {
   ...
   public static Object constructor(boolean newObj, Object self, Object... args) {
      CharSequence str = (CharSequence)(args.length > 0 ? JSType.toCharSequence(args[0]) : "");
   ...
   public SpecializedFunction.LinkLogic getLinkLogic(Class clazz) {
      return clazz == CharCodeAtLinkLogic.class ? NativeString.CharCodeAtLinkLogic.INSTANCE : null;
   }
