...
public final class Global extends Scope {
   ...
   public Object wrapAsObject(Object obj) {
      if (obj instanceof Boolean) {
         ...
         return new NativeArray(ArrayData.allocate(obj), this);
   ...
   private static Object getLazilyCreatedValue(Object key, Callable creator, Map map) {
      T obj = (T)map.get(key);
      if (obj != null) {
         return obj;
      } else {
         try {
            T newObj = (T)creator.call();
            T existingObj = (T)map.putIfAbsent(key, newObj);
   ...
   public InvokeByName getInvokeByName(Object key, Callable creator) {
      return (InvokeByName)getLazilyCreatedValue(key, creator, this.namedInvokers);
   }

   public MethodHandle getDynamicInvoker(Object key, Callable creator) {
   ...
   public static Object directEval(Object self, Object str, Object callThis, Object location, boolean strict) {
      if (!JSType.isString(str)) {
         ...
         Global global = instanceFrom(self);
         ScriptObject scope = (ScriptObject)(self instanceof ScriptObject && ((ScriptObject)self).isScope() ? (ScriptObject)self : global);
   ...
   public void addShellBuiltins() {
      ...
      Object var2 = ScriptFunction.createBuiltin("evalinput", ShellFunctions.EVALINPUT);
      this.addOwnProperty("evalinput", 2, var2);
   }
   ...
   private ScriptObject initConstructorAndSwitchPoint(String name, Class clazz) {
      T func = (T)this.initConstructor(name, clazz);
   ...
   private void init(ScriptEngine eng) {
      ...
      stringPrototype.addOwnProperty("length", 7, (double)0.0F);
   ...
   private void initScripting(ScriptEnvironment scriptEnv) {
      ...
      ScriptObject var6 = ScriptFunction.createBuiltin("readFully", ScriptingFunctions.READFULLY);
      this.addOwnProperty("readFully", 2, var6);
      String execName = "$EXEC";
      var6 = ScriptFunction.createBuiltin("$EXEC", ScriptingFunctions.EXEC);
      ((ScriptObject)var6).addOwnProperty("throwOnError", 2, false);
      this.addOwnProperty("$EXEC", 2, var6);
      var6 = (ScriptObject)this.get("print");
      this.addOwnProperty("echo", 2, var6);
   ...
   private ScriptObject initConstructor(String name, Class clazz) {
      try {
         ...
         T res = (T)((ScriptObject)clazz.cast(funcClass.newInstance()));
   ...
   private List extractBuiltinProperties(String name, ScriptObject func) {
