...
public final class NativeArray extends ScriptObject implements OptimisticBuiltins {
   ...
   private static InvokeByName getJOIN() {
      return Global.instance().getInvokeByName(JOIN, new Callable() {
   ...
   private static MethodHandle createIteratorCallbackInvoker(Object key, final Class rtype) {
      return Global.instance().getDynamicInvoker(key, new Callable() {
   ...
   private static MethodHandle getREDUCE_CALLBACK_INVOKER() {
      return Global.instance().getDynamicInvoker(REDUCE_CALLBACK_INVOKER, new Callable() {
         public MethodHandle call() {
   ...
   private static MethodHandle getCALL_CMP() {
      return Global.instance().getDynamicInvoker(CALL_CMP, new Callable() {
         public MethodHandle call() {
   ...
   private static InvokeByName getTO_LOCALE_STRING() {
      return Global.instance().getInvokeByName(TO_LOCALE_STRING, new Callable() {
         public InvokeByName call() {
      ...
      if (!desc.has("value")) {
         ...
         if (newLen >= oldLen) {
            ...
            if (!succeeded) {
               ...
               while(newLen < o) {
                  --o;
                  boolean deleteSucceeded = this.delete((double)o, false);
                  if (!deleteSucceeded) {
                     desc.setValue(o + 1L);
                     if (!newWritable) {
   ...
   private static void concatToList(ArrayList list, Object obj) {
   ...
   private static NativeArray slowSplice(ScriptObject sobj, long start, long deleteCount, Object[] items, long len) {
      ...
      if ((long)items.length < deleteCount) {
         ...
         for(long k = len; k > len - deleteCount + (long)items.length; --k) {
            sobj.delete((double)(k - 1L), true);
         }
   ...
   private static boolean applyEvery(Object self, Object callbackfn, Object thisArg) {
      return (Boolean)(new IteratorAction(Global.toObject(self), callbackfn, thisArg, true) {
   ...
   public static boolean some(Object self, Object callbackfn, Object thisArg) {
      return (Boolean)(new IteratorAction(Global.toObject(self), callbackfn, thisArg, false) {
   ...
   public static Object forEach(Object self, Object callbackfn, Object thisArg) {
      return (new IteratorAction(Global.toObject(self), callbackfn, thisArg, ScriptRuntime.UNDEFINED) {
   ...
   public static NativeArray map(Object self, Object callbackfn, Object thisArg) {
      return (NativeArray)(new IteratorAction(Global.toObject(self), callbackfn, thisArg, (NativeArray)null) {
         ...
         public void applyLoopBegin(ArrayLikeIterator iter0) {
   ...
   public static NativeArray filter(Object self, Object callbackfn, Object thisArg) {
      return (NativeArray)(new IteratorAction(Global.toObject(self), callbackfn, thisArg, new NativeArray()) {
         private long to = 0L;
   ...
   private static Object reduceInner(ArrayLikeIterator iter, Object self, Object... args) {
   ...
   public SpecializedFunction.LinkLogic getLinkLogic(Class clazz) {
      if (clazz == PushLinkLogic.class) {
         ...
         return clazz == ConcatLinkLogic.class ? NativeArray.ConcatLinkLogic.INSTANCE : null;
      }
   }
   ...
   private static final ContinuousArrayData getContinuousNonEmptyArrayDataCCE(Object self, Class clazz) {
      try {
