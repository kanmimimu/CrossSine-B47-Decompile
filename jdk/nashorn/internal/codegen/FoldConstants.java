...
final class FoldConstants extends SimpleNodeVisitor implements Loggable {
   ...
   private static boolean isUniqueIntegerLiteral(Expression expr, Set alreadySeen) {
   ...
   static void extractVarNodesFromDeadCode(Node deadCodeRoot, final List statements) {
   ...
   abstract static class ConstantEvaluator {
      ...
      protected ConstantEvaluator(Node parent) {
         this.parent = parent;
