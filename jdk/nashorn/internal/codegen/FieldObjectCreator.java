...
public abstract class FieldObjectCreator extends ObjectCreator {
   ...
   FieldObjectCreator(CodeGenerator codegen, List tuples) {
      this(codegen, tuples, false, false);
   }

   FieldObjectCreator(CodeGenerator codegen, List tuples, boolean isScope, boolean hasArguments) {
   ...
   private void putField(MethodEmitter method, String key, int fieldIndex, MapTuple tuple) {
   ...
   private void putSlot(MethodEmitter method, long index, MapTuple tuple) {
