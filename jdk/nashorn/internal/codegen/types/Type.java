...
public abstract class Type implements Comparable, BytecodeOps, Serializable {
   ...
   private static final Map INTERNAL_TYPE_CACHE = Collections.synchronizedMap(new WeakHashMap());
   ...
   public static void writeTypeMap(Map typeMap, DataOutput output) throws IOException {
      if (typeMap == null) {
         output.writeInt(0);
      } else {
   ...
   public static Map readTypeMap(DataInput input) throws IOException {
   ...
   private static Type putInCache(Type type) {
