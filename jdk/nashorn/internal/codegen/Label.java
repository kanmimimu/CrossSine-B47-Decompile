...
public final class Label implements Serializable {
   ...
   static final class Stack implements Cloneable {
      ...
      int sp;
      List localVariableTypes = new ArrayList(8);
      int firstTemp;
      ...
      private int getFirstDeadLocal(List types) {
         int i = types.size();

         for(ListIterator<Type> it = types.listIterator(i); it.hasPrevious() && it.previous() == Type.UNKNOWN; --i) {
         }
      ...
      List getLocalVariableTypesCopy() {
      ...
      List getWidestLiveLocals(List lvarTypes) {
