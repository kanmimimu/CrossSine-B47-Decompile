...
final class Lower extends NodeOperatorVisitor implements Loggable {
      ...
      super(new BlockLexicalContext() {
         ...
         protected Block afterSetStatements(Block block) {
            ...
            while(li.hasPrevious()) {
               Statement stmt = (Statement)li.previous();
   ...
   private static JumpToInlinedFinally createJumpToInlinedFinally(FunctionNode fn, List inlinedFinallies, Block finallyBlock) {
