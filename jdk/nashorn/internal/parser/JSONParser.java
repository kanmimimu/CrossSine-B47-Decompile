...
public class JSONParser {
   ...
   private PropertyMap addObjectProperty(PropertyMap propertyMap, List values, String id, Object value) {
   ...
   private Object createObject(PropertyMap propertyMap, List values, ArrayData arrayData) {
      ...
      ScriptObject object = (ScriptObject)(this.dualFields ? new JD(propertyMap, primitiveSpill, objectSpill) : new JO(propertyMap, (long[])null, objectSpill));
