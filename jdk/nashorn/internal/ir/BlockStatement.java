...
public class BlockStatement extends Statement {
   ...
   public static BlockStatement createReplacement(Statement stmt, List newStmts) {
      return createReplacement(stmt, stmt.getFinish(), newStmts);
   }

   public static BlockStatement createReplacement(Statement stmt, int finish, List newStmts) {
