...
public class RuntimeNode extends Expression {
   ...
   public RuntimeNode(long token, int finish, Request request, List args) {
      super(token, finish);
      this.request = request;
      this.args = args;
   }

   private RuntimeNode(RuntimeNode runtimeNode, Request request, List args) {
      super(runtimeNode);
      this.request = request;
      this.args = args;
   }
   ...
   public RuntimeNode(Expression parent, Request request, List args) {
      super(parent);
      this.request = request;
      this.args = args;
   }
   ...
   public RuntimeNode setArgs(List args) {
