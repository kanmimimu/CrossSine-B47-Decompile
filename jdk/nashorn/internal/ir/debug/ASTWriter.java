...
public final class ASTWriter {
   ...
   private void printAST(StringBuilder sb, List preorder, Field field, String name, Node node, int indent) {
      indent(sb, indent);
      if (node == null) {
         sb.append("[Object ");
         sb.append(name);
   ...
   private static void enqueueChildren(Node node, Class nodeClass, List children) {
      ...
      Iterator<Class<?>> iter = node instanceof BinaryNode ? stack.descendingIterator() : stack.iterator();
