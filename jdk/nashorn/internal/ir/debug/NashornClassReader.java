...
public class NashornClassReader extends ClassReader {
   ...
   List getExtraLabels(String className, String methodName, String methodDesc) {
   ...
   private abstract static class Constant {
      ...
      protected Constant(ArrayList cp, int tag) {
         this.cp = cp;
         this.tag = tag;
      }
   ...
   private static class IndexInfo extends Constant {
      ...
      IndexInfo(ArrayList cp, int tag, int index) {
         super(cp, tag);
         this.index = index;
      }
   ...
   private static class IndexInfo2 extends IndexInfo {
      ...
      IndexInfo2(ArrayList cp, int tag, int index, int index2) {
         super(cp, tag, index);
         this.index2 = index2;
      }
   ...
   private static class DirectInfo extends Constant {
      ...
      DirectInfo(ArrayList cp, int tag, Object info) {
         super(cp, tag);
         this.info = info;
      }
