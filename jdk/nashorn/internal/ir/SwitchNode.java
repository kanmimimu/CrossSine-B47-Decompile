...
public final class SwitchNode extends BreakableStatement {
   ...
   public SwitchNode(int lineNumber, long token, int finish, Expression expression, List cases, CaseNode defaultCase) {
   ...
   private SwitchNode(SwitchNode switchNode, Expression expression, List cases, int defaultCaseIndex, LocalVariableConversion conversion, boolean uniqueInteger, Symbol tag) {
   ...
   public SwitchNode setCases(LexicalContext lc, List cases) {
      return this.setCases(lc, cases, this.defaultCaseIndex);
   }

   private SwitchNode setCases(LexicalContext lc, List cases, int defaultCaseIndex) {
   ...
   public SwitchNode setCases(LexicalContext lc, List cases, CaseNode defaultCase) {
