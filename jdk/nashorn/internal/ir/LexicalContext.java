...
public class LexicalContext {
   ...
   public LexicalContextNode applyTopFlags(LexicalContextNode node) {
   ...
   public Block getParentBlock() {
      Iterator<Block> iter = new NodeIterator(Block.class, this.getCurrentFunction());
      iter.next();
   ...
   private BreakableNode getBreakable() {
      NodeIterator<BreakableNode> iter = new NodeIterator(BreakableNode.class, this.getCurrentFunction());
   ...
   public LoopNode getCurrentLoop() {
      Iterator<LoopNode> iter = new NodeIterator(LoopNode.class, this.getCurrentFunction());
   ...
   public BreakableNode getBreakable(String labelName) {
      if (labelName == null) {
         ...
         if (foundLabel == null) {
            ...
            for(NodeIterator<BreakableNode> iter = new NodeIterator(BreakableNode.class, foundLabel); iter.hasNext(); breakable = (BreakableNode)iter.next()) {
            }
   ...
   public LoopNode getContinueTo(String labelName) {
      if (labelName == null) {
         ...
         if (foundLabel == null) {
            ...
            for(NodeIterator<LoopNode> iter = new NodeIterator(LoopNode.class, foundLabel); iter.hasNext(); loop = (LoopNode)iter.next()) {
            }
   ...
   public Block getInlinedFinally(String labelName) {
      NodeIterator<TryNode> iter = new NodeIterator(TryNode.class);
   ...
   public LabelNode findLabel(String name) {
      Iterator<LabelNode> iter = new NodeIterator(LabelNode.class, this.getCurrentFunction());
   ...
   private class NodeIterator implements Iterator {
      ...
      NodeIterator(Class clazz) {
         this(clazz, (LexicalContextNode)null);
      }

      NodeIterator(Class clazz, LexicalContextNode until) {
