...
public final class FunctionNode extends LexicalContextExpression implements Flags, CompileUnitHolder {
   ...
   public FunctionNode(Source source, int lineNumber, long token, int finish, long firstToken, Namespace namespace, IdentNode ident, String name, List parameters, Kind kind, int flags) {
      super(token, finish);
   ...
   private FunctionNode(FunctionNode functionNode, long lastToken, Object endParserState, int flags, String name, Type returnType, CompileUnit compileUnit, Block body, List parameters, int thisProperties, Class rootClass, Source source, Namespace namespace) {
      super(functionNode);
      this.returnType = Type.UNKNOWN;
   ...
   public List visitParameters(NodeVisitor visitor) {
   ...
   public FunctionNode setParameters(LexicalContext lc, List parameters) {
