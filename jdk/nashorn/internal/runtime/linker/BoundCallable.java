...
public final class BoundCallable {
   ...
   BoundCallable(Object callable, Object boundThis, Object[] boundArgs) {
      ...
      this.boundArgs = isEmptyArray(boundArgs) ? ScriptRuntime.EMPTY_ARRAY : (Object[])((Object;)boundArgs).clone();
   }
   ...
   BoundCallable bind(Object[] extraBoundArgs) {
      return isEmptyArray(extraBoundArgs) ? this : new BoundCallable(this, extraBoundArgs);
   }
