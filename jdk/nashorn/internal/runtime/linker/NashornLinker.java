...
final class NashornLinker implements TypeBasedGuardingDynamicLinker, GuardingTypeConverterFactory, ConversionComparator {
   private static final ClassValue ARRAY_CONVERTERS = new ClassValue() {
   ...
   private static MethodHandles.Lookup getCurrentLookup() {
      LinkRequest currentRequest = (LinkRequest)AccessController.doPrivileged(new PrivilegedAction() {
