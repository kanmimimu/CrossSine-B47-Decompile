         ...
         if ("new".equals(desc.getNameToken(1))) {
            if (!Modifier.isPublic(receiverClass.getModifiers())) {
               ...
               if (NashornLinker.isAbstractClass(receiverClass)) {
                  ...
                  args[0] = JavaAdapterFactory.getAdapterClassFor(new Class[]{receiverClass}, (ScriptObject)null, (MethodHandles.Lookup)linkRequest.getCallSiteDescriptor().getLookup());
