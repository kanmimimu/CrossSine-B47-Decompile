...
final class JavaAdapterClassLoader {
   ...
   private static final Collection VISIBLE_INTERNAL_CLASS_NAMES = Collections.unmodifiableCollection(new HashSet(Arrays.asList(JavaAdapterServices.class.getName(), ScriptObject.class.getName(), ScriptFunction.class.getName(), JSType.class.getName())));
   ...
   StaticClass generateClass(final ClassLoader parentLoader, final ProtectionDomain protectionDomain) {
      ...
      return (StaticClass)AccessController.doPrivileged(new PrivilegedAction() {
