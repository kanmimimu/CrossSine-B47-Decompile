...
public class LinkerCallSite extends ChainedCallSite {
   ...
   private static final HashMap missCounts;
   ...
   static LinkerCallSite newLinkerCallSite(MethodHandles.Lookup lookup, String name, MethodType type, int flags) {
      ...
      if (desc.isProfile()) {
         ...
         return (LinkerCallSite)(desc.isTrace() ? new TracingLinkerCallSite(desc) : new LinkerCallSite(desc));
      }
   }
   ...
   private static class ProfilingLinkerCallSite extends LinkerCallSite {
      ...
      static {
         PROFILEENTRY = Lookup.MH.findVirtual(LOOKUP, ProfilingLinkerCallSite.class, "profileEntry", Lookup.MH.type(Object.class, Object.class));
         PROFILEEXIT = Lookup.MH.findVirtual(LOOKUP, ProfilingLinkerCallSite.class, "profileExit", Lookup.MH.type(Object.class, Object.class));
         PROFILEVOIDEXIT = Lookup.MH.findVirtual(LOOKUP, ProfilingLinkerCallSite.class, "profileVoidExit", Lookup.MH.type(Void.TYPE));
      }
      ...
      static class ProfileDumper implements Runnable {
         ...
         private static void dump(PrintWriter out) {
            ...
            for(ProfilingLinkerCallSite callSite : LinkerCallSite.ProfilingLinkerCallSite.profileCallSites) {
   ...
   private static class TracingLinkerCallSite extends LinkerCallSite {
      ...
      static {
         TRACEOBJECT = Lookup.MH.findVirtual(LOOKUP, TracingLinkerCallSite.class, "traceObject", Lookup.MH.type(Object.class, MethodHandle.class, Object[].class));
         TRACEVOID = Lookup.MH.findVirtual(LOOKUP, TracingLinkerCallSite.class, "traceVoid", Lookup.MH.type(Void.TYPE, MethodHandle.class, Object[].class));
         TRACEMISS = Lookup.MH.findVirtual(LOOKUP, TracingLinkerCallSite.class, "traceMiss", Lookup.MH.type(Void.TYPE, String.class, Object[].class));
      }
   }
}
