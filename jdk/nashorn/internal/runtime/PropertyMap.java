...
public class PropertyMap implements Iterable, Serializable {
   ...
   private transient HashMap protoSwitches;
   ...
   public static PropertyMap newMap(Collection properties, String className, int fieldCount, int fieldMaximum, int spillLength) {
   ...
   public static PropertyMap newMap(Collection properties) {
      return properties != null && !properties.isEmpty() ? newMap(properties, JO.class.getName(), 0, 0, 0) : newMap();
   }

   public static PropertyMap newMap(Class clazz) {
   ...
   private void updateFreeSlots(Property oldProperty, Property newProperty) {
      ...
      if (oldProperty != null) {
         int slotIndex = this.logicalSlotIndex(oldProperty);
         if (slotIndex >= 0) {
      ...
      if (this.freeSlots != null && newProperty != null) {
         int slotIndex = this.logicalSlotIndex(newProperty);
   ...
   private static class PropertyMapIterator implements Iterator {
      final Iterator iter;
      Property property;
