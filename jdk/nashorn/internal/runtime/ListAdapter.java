...
public class ListAdapter extends AbstractList implements RandomAccess, Deque {
   private static final Callable ADD_INVOKER_CREATOR;
   private static final Object PUSH;
   private static final Object UNSHIFT;
   private static final Callable REMOVE_INVOKER_CREATOR;
   private static final Object POP;
   private static final Object SHIFT;
   private static final Object SPLICE_ADD;
   private static final Callable SPLICE_ADD_INVOKER_CREATOR;
   private static final Object SPLICE_REMOVE;
   private static final Callable SPLICE_REMOVE_INVOKER_CREATOR;
   final JSObject obj;
   ...
   private static boolean removeOccurrence(Object o, Iterator it) {
      while(true) {
         if (it.hasNext()) {
   ...
   private MethodHandle getDynamicInvoker(Object key, Callable creator) {
