...
public abstract class CodeStore implements Loggable {
   ...
   public StoredScript store(String functionKey, Source source, String mainClassName, Map classBytes, Map initializers, Object[] constants, int compilationId) {
   ...
   public StoredScript storedScriptFor(Source source, String mainClassName, Map classBytes, Map initializers, Object[] constants, int compilationId) {
   ...
   public static class DirectoryCodeStore extends CodeStore {
      ...
      public StoredScript load(final Source source, final String functionKey) {
         if (this.belowThreshold(source)) {
            ...
            try {
               return (StoredScript)AccessController.doPrivileged(new PrivilegedExceptionAction() {
