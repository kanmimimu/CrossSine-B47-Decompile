...
final class DebuggerSupport {
   ...
   private static DebuggerValueDesc valueInfo(String name, Object value, boolean all, Set duplicates) {
   ...
   private static DebuggerValueDesc[] getDebuggerValueDescs(ScriptObject object, boolean all, Set duplicates) {
   ...
   private static String objectAsString(ScriptObject object, boolean all, Set duplicates) {
   ...
   static {
      new DebuggerValueDesc((String)null, false, (Object)null, (String)null);
      new SourceInfo((String)null, 0, (URL)null, (char[])null);
   }
