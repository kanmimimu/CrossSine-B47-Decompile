...
public class AccessorProperty extends Property {
   ...
   private static ClassValue GETTERS_SETTERS = new ClassValue() {
   ...
   private static MethodHandle bindTo(MethodHandle mh, Object receiver) {
      return mh == null ? null : Lookup.MH.dropArguments(Lookup.MH.bindTo(mh, receiver), 0, (Class[])(Object.class));
   }
   ...
   public MethodHandle getSetter(Class type, PropertyMap currentMap) {
      ...
      if (this.isBuiltin()) {
         mh = Lookup.MH.filterArguments(mh, 0, debugInvalidate(Lookup.MH.insertArguments(INVALIDATE_SP, 0, this), this.getKey()));
      }
   ...
   private MethodHandle debug(MethodHandle mh, final Class forType, final Class type, final String tag) {
      if (Context.DEBUG && Global.hasInstance()) {
         ...
         return context.addLoggingToHandle(ObjectClassGenerator.class, Level.INFO, mh, 0, true, new Supplier() {
            public String get() {
   ...
   private MethodHandle debugReplace(final Class oldType, final Class newType, final PropertyMap oldMap, final PropertyMap newMap) {
      if (Context.DEBUG && Global.hasInstance()) {
         ...
         MethodHandle mh = context.addLoggingToHandle(ObjectClassGenerator.class, REPLACE_MAP, new Supplier() {
            public String get() {
               return "Type change for '" + AccessorProperty.this.getKey() + "' " + oldType + "=>" + newType;
            }
         });
         mh = context.addLoggingToHandle(ObjectClassGenerator.class, Level.FINEST, mh, Integer.MAX_VALUE, false, new Supplier() {
            public String get() {
   ...
   private static MethodHandle debugInvalidate(MethodHandle invalidator, final String key) {
      if (Context.DEBUG && Global.hasInstance()) {
         ...
         return context.addLoggingToHandle(ObjectClassGenerator.class, invalidator, new Supplier() {
            public String get() {
