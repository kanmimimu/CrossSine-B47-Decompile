...
public final class Context {
   ...
   private final Map builtinSwitchPoints;
   public static final boolean DEBUG;
   private static final ThreadLocal currentGlobal;
   private ClassCache classCache;
   private CodeStore codeStore;
   private final AtomicReference globalConstantsRef;
   ...
   private static Source loadInternal(final String srcStr, String prefix, String resourcePath) {
      if (srcStr.startsWith(prefix)) {
         ...
         return (Source)AccessController.doPrivileged(new PrivilegedAction() {
            public Source run() {
               try {
   ...
   public Object load(Object scope, Object from) throws IOException {
      ...
      if (src instanceof String) {
         ...
         if (srcStr.startsWith("classpath:")) {
            URL url = this.getResourceURL(srcStr.substring("classpath:".length()));
   ...
   public Object loadWithNewGlobal(Object from, Object... args) throws IOException {
      ...
      Global newGlobal = (Global)AccessController.doPrivileged(new PrivilegedAction() {
         public Global run() {
            try {
   ...
   private synchronized Class compile(Source source, ErrorManager errMan, boolean strict) {
      ...
      if (script != null) {
         ...
         if (this.env._parse_only) {
            ...
            CodeInstaller installer = new ContextCodeInstaller(this, loader, cs);
            if (storedScript == null) {
   ...
   private ScriptLoader createNewLoader() {
      return (ScriptLoader)AccessController.doPrivileged(new PrivilegedAction() {
   ...
   public DebugLogger getLogger(Class clazz, Consumer initHook) {
   ...
   public MethodHandle addLoggingToHandle(Class clazz, MethodHandle mh, Supplier text) {
      return this.addLoggingToHandle(clazz, Level.INFO, mh, Integer.MAX_VALUE, false, text);
   }

   public MethodHandle addLoggingToHandle(Class clazz, Level level, MethodHandle mh, int paramStart, boolean printReturnValue, Supplier text) {
   ...
   static {
      ...
      theStructLoader = (StructureLoader)AccessController.doPrivileged(new PrivilegedAction() {
   ...
   public static class ContextCodeInstaller implements CodeInstaller {
      ...
      public void storeScript(String cacheKey, Source source, String mainClassName, Map classBytes, Map initializers, Object[] constants, int compilationId) {
      ...
      public CodeInstaller withNewLoader() {
         return this.usageCount < 10 && this.bytesDefined < 200000 ? this : new ContextCodeInstaller(this.context, this.context.createNewLoader(), this.codeSource);
      }
   ...
   private static class ClassReference extends SoftReference {
      ...
      ClassReference(Class clazz, ReferenceQueue queue, Source source) {
         super(clazz, queue);
         this.source = source;
      }
   }
