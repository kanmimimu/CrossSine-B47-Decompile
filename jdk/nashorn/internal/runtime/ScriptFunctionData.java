...
public abstract class ScriptFunctionData implements Serializable {
   ...
   final CompiledFunction getBestInvoker(MethodType callSiteType, ScriptObject runtimeScope, Collection forbidden) {
   ...
   final CompiledFunction getBestConstructor(MethodType callSiteType, ScriptObject runtimeScope, Collection forbidden) {
   ...
   abstract CompiledFunction getBest(MethodType var1, ScriptObject var2, Collection var3, boolean var4);

   final CompiledFunction getBest(MethodType callSiteType, ScriptObject runtimeScope, Collection forbidden) {
