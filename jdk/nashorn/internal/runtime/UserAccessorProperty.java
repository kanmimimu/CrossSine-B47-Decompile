...
public final class UserAccessorProperty extends SpillProperty {
   ...
   private static final MethodHandle INVOKE_OBJECT_GETTER = findOwnMH_S("invokeObjectGetter", Object.class, Accessors.class, MethodHandle.class, Object.class);
   ...
   private static MethodHandle getObjectGetterInvoker() {
      return Context.getGlobal().getDynamicInvoker(OBJECT_GETTER_INVOKER_KEY, new Callable() {
   ...
   private static MethodHandle getObjectSetterInvoker() {
      return Context.getGlobal().getDynamicInvoker(OBJECT_SETTER_INVOKER_KEY, new Callable() {
         public MethodHandle call() throws Exception {
