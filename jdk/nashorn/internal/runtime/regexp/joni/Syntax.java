...
public final class Syntax implements SyntaxProperties {
   ...
   static {
      DEFAULT = RUBY;
      ASIS = new Syntax(0, 1048576, 0, 0, new MetaCharTable(92, 0, 0, 0, 0, 0));
      ...
      Emacs = new Syntax(75704918, 32768, 4194304, 0, new MetaCharTable(92, 0, 0, 0, 0, 0));
      Grep = new Syntax(27208358, 0, 5242880, 0, new MetaCharTable(92, 0, 0, 0, 0, 0));
