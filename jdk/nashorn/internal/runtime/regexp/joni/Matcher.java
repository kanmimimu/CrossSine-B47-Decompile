      ...
      if (startp <= this.end && startp >= this.str) {
         if (this.regex.anchor != 0 && this.str < this.end) {
            if ((this.regex.anchor & 4) != 0) {
               ...
               int maxSemiEnd;
               int minSemiEnd = maxSemiEnd = this.end;
               if (this.endBuf(startp, rangep, minSemiEnd, maxSemiEnd)) {
                  return -1;
               }
               ...
               if (EncodingHelper.isNewLine(this.chars, preEnd, this.end)) {
                  if (preEnd > this.str && startp <= preEnd && this.endBuf(startp, rangep, preEnd, maxSemiEnd)) {
                     return -1;
                  }
               } else {
