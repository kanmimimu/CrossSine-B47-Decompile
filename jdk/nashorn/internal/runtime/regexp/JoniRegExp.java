...
public class JoniRegExp extends RegExp {
   ...
   public JoniRegExp(String pattern, String flags) throws ParserException {
      ...
      } catch (JOniException | PatternSyntaxException e2) {
         throwParserException("syntax", ((RuntimeException)e2).getMessage());
      }

   }

   public RegExpMatcher match(String input) {
      return this.regex == null ? null : new JoniMatcher(input);
   }
