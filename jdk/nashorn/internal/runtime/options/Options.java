...
public final class Options {
   ...
   private static HashMap usage = new HashMap();
   private static Collection validOptions = new TreeSet();
   ...
   private void processArgList(LinkedList argList) {
   ...
   private static void addSystemProperties(String sysPropName, List argList) {
   ...
   private static void initProps(KeyValueOption kv) {
      for(Map.Entry entry : kv.getValues().entrySet()) {
