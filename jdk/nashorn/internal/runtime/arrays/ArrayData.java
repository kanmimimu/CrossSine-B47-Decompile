...
public abstract class ArrayData {
   ...
   public static ArrayData allocate(Object array) {
      ...
      if (clazz == int[].class) {
         return new IntArrayData((int[])array, ((int[])((int[])array)).length);
      } else {
         return (ArrayData)(clazz == double[].class ? new NumberArrayData((double[])array, ((double[])((double[])array)).length) : new ObjectArrayData(array, ((Object[])((Object[])array)).length));
      }
   }
   ...
   protected List computeIteratorKeys() {
   ...
   public GuardedInvocation findFastCallMethod(Class clazz, CallSiteDescriptor desc, LinkRequest request) {
      return null;
   }

   public GuardedInvocation findFastGetMethod(Class clazz, CallSiteDescriptor desc, LinkRequest request, String operator) {
      return null;
   }
