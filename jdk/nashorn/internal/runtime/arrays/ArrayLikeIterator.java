...
public abstract class ArrayLikeIterator implements Iterator {
   ...
   public static ArrayLikeIterator arrayLikeIterator(Object object) {
      return arrayLikeIterator(object, false);
   }

   public static ArrayLikeIterator reverseArrayLikeIterator(Object object) {
      return reverseArrayLikeIterator(object, false);
   }

   public static ArrayLikeIterator arrayLikeIterator(Object object, boolean includeUndefined) {
   ...
   public static ArrayLikeIterator reverseArrayLikeIterator(Object object, boolean includeUndefined) {
      if (ScriptObject.isArray(object)) {
