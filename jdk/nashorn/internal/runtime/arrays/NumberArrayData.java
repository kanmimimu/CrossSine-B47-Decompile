...
final class NumberArrayData extends ContinuousArrayData implements NumericElements {
   ...
   public ArrayData shrink(long newLength) {
      Arrays.fill(this.array, (int)newLength, this.array.length, (double)0.0F);
      return this;
   }
   ...
   public Object pop() {
      ...
      if (len == 0) {
         ...
         this.array[newLength] = (double)0.0F;
   ...
   public ArrayData fastSplice(int start, int removed, int added) throws UnsupportedOperationException {
      ...
      if (newLength > 131072L && newLength > (long)this.array.length) {
         ...
         ArrayData returnValue = (ArrayData)(removed == 0 ? EMPTY_ARRAY : new NumberArrayData(Arrays.copyOfRange(this.array, start, start + removed), removed));
