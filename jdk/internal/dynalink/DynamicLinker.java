...
public class DynamicLinker {
   ...
   public RelinkableCallSite link(RelinkableCallSite callSite) {
   ...
   private MethodHandle relink(RelinkableCallSite callSite, int relinkCount, Object... arguments) throws Exception {
      ...
      LinkRequest linkRequest = (LinkRequest)(this.runtimeContextArgCount == 0 ? new LinkRequestImpl(callSiteDescriptor, callSite, relinkCount, callSiteUnstable, arguments) : new RuntimeContextLinkRequestImpl(callSiteDescriptor, callSite, relinkCount, callSiteUnstable, arguments, this.runtimeContextArgCount));
