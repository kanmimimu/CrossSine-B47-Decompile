...
public class CallSiteDescriptorFactory {
   ...
   protected static Reference createReference(CallSiteDescriptor desc) {
   ...
   public static List tokenizeOperators(CallSiteDescriptor desc) {
   ...
   public static CallSiteDescriptor insertParameterTypes(CallSiteDescriptor desc, int num, List ptypesToInsert) {
      return desc.changeMethodType(desc.getMethodType().insertParameterTypes(num, ptypesToInsert));
   }
}
