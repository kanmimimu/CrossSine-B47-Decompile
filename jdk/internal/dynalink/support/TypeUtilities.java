...
public class TypeUtilities {
   ...
   private static final Map WRAPPER_TYPES = createWrapperTypes();
   ...
   private static Map createClassNameMapping(Collection classes) {
   ...
   private static void addClassHierarchy(Map map, Class clazz) {
      if (clazz != null) {
         map.put(clazz, clazz);
