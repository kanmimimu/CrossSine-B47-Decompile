...
class StaticClassLinker implements TypeBasedGuardingDynamicLinker {
   ...
   public GuardedInvocation getGuardedInvocation(LinkRequest request, LinkerServices linkerServices) throws Exception {
      ...
      return receiver instanceof StaticClass ? ((SingleClassStaticsLinker)linkers.get(((StaticClass)receiver).getRepresentedClass())).getGuardedInvocation(request, linkerServices) : null;
   }
