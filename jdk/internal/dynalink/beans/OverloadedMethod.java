...
class OverloadedMethod {
   ...
   OverloadedMethod(List methodHandles, OverloadedDynamicMethod parent, MethodType callSiteType, LinkerServices linkerServices) {
      this.parent = parent;
   ...
   private MethodHandle getAmbiguousMethodThrower(Class[] argTypes, List methods) {
   ...
   private void throwAmbiguousMethod(Class[] argTypes, List methods) throws NoSuchMethodException {
   ...
   private static String getSignatureList(List methods) {
      StringBuilder b = (new StringBuilder()).append('[');
