...
abstract class AbstractJavaLinker implements GuardingDynamicLinker {
   ...
   AbstractJavaLinker(Class clazz, MethodHandle classGuard, MethodHandle assignableGuard) {
      ...
      for(Map.Entry innerClassSpec : introspector.getInnerClassGetters().entrySet()) {
   ...
   protected GuardedInvocationComponent getGuardedInvocationComponent(CallSiteDescriptor callSiteDescriptor, LinkerServices linkerServices, List operations) throws Exception {
   ...
   private GuardedInvocation createGuardedDynamicMethodInvocation(CallSiteDescriptor callSiteDescriptor, LinkerServices linkerServices, String methodName, Map methodMap) {
   ...
   private MethodHandle getDynamicMethodInvocation(CallSiteDescriptor callSiteDescriptor, LinkerServices linkerServices, String methodName, Map methodMap) {
   ...
   private DynamicMethod getDynamicMethod(String methodName, Map methodMap) {
   ...
   private SingleDynamicMethod getExplicitSignatureDynamicMethod(String fullName, Map methodsMap) {
   ...
   private GuardedInvocationComponent getPropertySetter(CallSiteDescriptor callSiteDescriptor, LinkerServices linkerServices, List operations) throws Exception {
      switch (callSiteDescriptor.getNameTokenCount()) {
         case 2:
   ...
   private GuardedInvocationComponent getPropertyGetter(CallSiteDescriptor callSiteDescriptor, LinkerServices linkerServices, List ops) throws Exception {
      switch (callSiteDescriptor.getNameTokenCount()) {
         case 2:
            ...
            if (nextComponent == null) {
               ...
               fallbackFolded = MethodHandles.dropArguments(nextInvocation.asType(nextType.changeReturnType(Object.class)), 0, new Class[]{AnnotatedDynamicMethod.class});
            }
         ...
         case 3:
            ...
            AnnotatedDynamicMethod annGetter = (AnnotatedDynamicMethod)this.propertyGetters.get(callSiteDescriptor.getNameToken(2));
            if (annGetter == null) {
   ...
   private GuardedInvocationComponent getMethodGetter(CallSiteDescriptor callSiteDescriptor, LinkerServices linkerServices, List ops) throws Exception {
      MethodType type = callSiteDescriptor.getMethodType().changeReturnType(Object.class);
      switch (callSiteDescriptor.getNameTokenCount()) {
         case 2:
            assertParameterCount(callSiteDescriptor, 2);
   ...
   static {
      ...
      CONSTANT_NULL_DROP_ANNOTATED_METHOD = MethodHandles.dropArguments(MethodHandles.constant(Object.class, (Object)null), 0, new Class[]{AnnotatedDynamicMethod.class});
