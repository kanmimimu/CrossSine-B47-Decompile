...
class BeanLinker extends AbstractJavaLinker implements TypeBasedGuardingDynamicLinker {
   ...
   private GuardedInvocationComponent getElementGetter(CallSiteDescriptor callSiteDescriptor, LinkerServices linkerServices, List operations) throws Exception {
   ...
   private GuardedInvocationComponent getElementSetter(CallSiteDescriptor callSiteDescriptor, LinkerServices linkerServices, List operations) throws Exception {
      MethodType callSiteType = callSiteDescriptor.getMethodType();
      Class<?> declaredType = callSiteType.parameterType(0);
      GuardedInvocationComponent gic;
      CollectionType collectionType;
