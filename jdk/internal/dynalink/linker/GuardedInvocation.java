...
import [Ljava.lang.invoke.SwitchPoint;;
...
public class GuardedInvocation {
   ...
   public GuardedInvocation(MethodHandle invocation, MethodHandle guard, SwitchPoint switchPoint, Class exception) {
   ...
   public GuardedInvocation(MethodHandle invocation, MethodHandle guard, SwitchPoint[] switchPoints, Class exception) {
      this.invocation = (MethodHandle)Objects.requireNonNull(invocation);
      this.guard = guard;
      this.switchPoints = switchPoints == null ? null : (SwitchPoint[])((SwitchPoint;)switchPoints).clone();
      this.exception = exception;
   }
   ...
   public GuardedInvocation dropArguments(int pos, List valueTypes) {
