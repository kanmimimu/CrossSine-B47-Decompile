...
public class DynamicLinkerFactory {
   ...
   public void setPrioritizedLinkers(List prioritizedLinkers) {
   ...
   public void setFallbackLinkers(List fallbackLinkers) {
   ...
   private static void addClasses(Set knownLinkerClasses, List linkers) {
      for(GuardingDynamicLinker linker : linkers) {
