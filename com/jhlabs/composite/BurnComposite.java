   ...
   static class Context extends RGBComposite.RGBCompositeContext {
      ...
      public void composeRGB(int[] src, int[] dst, float alpha) {
         ...
         for(int i = 0; i < w; i += 4) {
            ...
            int dor;
            if (dir != 255) {
               dor = RGBComposite.RGBCompositeContext.clamp(255 - (255 - sr << 8) / (dir + 1));
            } else {
               dor = sr;
            }
            ...
            int dog;
            if (dig != 255) {
               dog = RGBComposite.RGBCompositeContext.clamp(255 - (255 - sg << 8) / (dig + 1));
            } else {
               dog = sg;
            }
            ...
            int dob;
            if (dib != 255) {
               dob = RGBComposite.RGBCompositeContext.clamp(255 - (255 - sb << 8) / (dib + 1));
            } else {
               dob = sb;
            }
