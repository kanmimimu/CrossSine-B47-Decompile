   ...
   public BufferedImage filter(BufferedImage src, BufferedImage dst) {
      ...
      if (this.borderPaint != null) {
         ...
         if (this.leftBorder > 0) {
            ((Graphics)g).fillRect(0, 0, this.leftBorder, height);
         }

         if (this.rightBorder > 0) {
            ((Graphics)g).fillRect(width - this.rightBorder, 0, this.rightBorder, height);
         }

         if (this.topBorder > 0) {
            ((Graphics)g).fillRect(this.leftBorder, 0, width - this.leftBorder - this.rightBorder, this.topBorder);
         }

         if (this.bottomBorder > 0) {
            ((Graphics)g).fillRect(this.leftBorder, height - this.bottomBorder, width - this.leftBorder - this.rightBorder, this.bottomBorder);
         }
      }
