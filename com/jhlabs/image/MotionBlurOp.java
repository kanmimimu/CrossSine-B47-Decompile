...
public class MotionBlurOp extends AbstractBufferedImageOp {
   ...
   public BufferedImage filter(BufferedImage src, BufferedImage dst) {
      ...
      if (steps == 0) {
         ...
         BufferedImage tmp = ((AbstractBufferedImageOp)this).createCompatibleDestImage(src, (ColorModel)null);

         for(int i = 0; i < steps; ++i) {
            Graphics2D g = tmp.createGraphics();
            g.drawImage(tsrc, (AffineTransform)null, (ImageObserver)null);
            ...
            g.drawImage(dst, (AffineTransform)null, (ImageObserver)null);
            ((Graphics)g).dispose();
