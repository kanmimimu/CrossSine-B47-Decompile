...
public final class IPCClient implements Closeable {
   ...
   public void close() {
      ...
      try {
         ...
         LOGGER.debug((String)"Failed to close pipe", (Throwable)e);
      }
         ...
         try {
            while(true) {
               ...
               if ((p = this.pipe.read()).getOp() != Packet.OpCode.CLOSE) {
                  ...
                  Event event = IPCClient.Event.of(json.optString("evt", (String)null));
                  ...
                  if (this.listener != null && json.has("cmd") && json.getString("cmd").equals("DISPATCH")) {
                     try {
                        ...
                        LOGGER.error((String)"Exception when handling event: ", (Throwable)e);
                     }
                  }
               } else {
