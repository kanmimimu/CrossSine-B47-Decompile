...
public final class Protocol1_20_2To1_20 extends BackwardsProtocol {
   ...
   protected void registerPackets() {
      ...
      this.registerClientbound(State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.FINISH_CONFIGURATION, (wrapper) -> {
         wrapper.cancel();
      ...
      this.registerClientbound(ClientboundPackets1_20_2.START_CONFIGURATION, (ClientboundPacketType)null, (wrapper) -> {
         wrapper.cancel();
      ...
      this.registerClientbound(State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.UPDATE_TAGS.getId(), -1, (wrapper) -> {
         ...
         ((ConfigurationPacketStorage)wrapper.user().get(ConfigurationPacketStorage.class)).addRawPacket(wrapper, ClientboundPackets1_19_4.UPDATE_TAGS);
         wrapper.cancel();
      });
      this.registerClientbound(State.CONFIGURATION, ClientboundConfigurationPackets1_20_2.CUSTOM_PAYLOAD.getId(), -1, (wrapper) -> {
         ((ConfigurationPacketStorage)wrapper.user().get(ConfigurationPacketStorage.class)).addRawPacket(wrapper, ClientboundPackets1_19_4.CUSTOM_PAYLOAD);
         wrapper.cancel();
      });
   }
      ...
      if (configurationPacketStorage != null && !configurationPacketStorage.isFinished()) {
         if (direction == Direction.CLIENTBOUND) {
            ...
            if (id == ServerboundPackets1_19_4.CLIENT_INFORMATION.getId()) {
               ...
               if (id != ServerboundPackets1_19_4.RESOURCE_PACK.getId()) {
