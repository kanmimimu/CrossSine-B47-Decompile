...
public final class EntityPacketRewriter1_17 extends EntityRewriter {
   ...
   protected void registerPackets() {
      ...
      ((Protocol1_17To1_16_4)this.protocol).appendClientbound(ClientboundPackets1_17.ADD_ENTITY, (wrapper) -> {
         ...
         if (entityType == EntityTypes1_16_2.ITEM_FRAME.getId()) {
            ...
            wrapper.set(Types.BYTE, 0, (byte)((int)(pitch * 256.0F / 360.0F)));
            wrapper.set(Types.BYTE, 1, (byte)((int)(yaw * 256.0F / 360.0F)));
         }
      });
      ...
      ((Protocol1_17To1_16_4)this.protocol).registerClientbound(ClientboundPackets1_17.LOGIN, new PacketHandlers() {
         public void register() {
            ...
            this.handler((wrapper) -> {
               byte previousGamemode = (Byte)wrapper.get(Types.BYTE, 1);
   ...
   protected void registerRewrites() {
      ...
      this.registerEntityDataTypeHandler(Types1_16.ENTITY_DATA_TYPES.itemType, (EntityDataType)null, Types1_16.ENTITY_DATA_TYPES.optionalBlockStateType, (EntityDataType)null, Types1_16.ENTITY_DATA_TYPES.componentType, Types1_16.ENTITY_DATA_TYPES.optionalComponentType);
