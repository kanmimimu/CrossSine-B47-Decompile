...
public final class BiomeMappings1_16_1 {
   ...
   static {
      ...
      for(Map.Entry entry : mappings.entrySet()) {
         int legacyBiome = LEGACY_BIOMES.getInt(((JsonElement)entry.getValue()).getAsString());
         if (legacyBiome == -1) {
            ProtocolLogger var10000 = Protocol1_16_2To1_16_1.LOGGER;
            String var5 = ((JsonElement)entry.getValue()).getAsString();
            var10000.warning("Unknown legacy biome: " + var5);
         } else {
            MODERN_TO_LEGACY_ID.put((String)entry.getKey(), legacyBiome);
         }
      }
