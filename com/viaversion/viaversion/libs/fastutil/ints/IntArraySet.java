...
public class IntArraySet extends AbstractIntSet implements Serializable, Cloneable {
      ...
      return new IntIterator() {
         ...
         public int nextInt() {
            if (!this.hasNext()) {
               ...
               return IntArraySet.this.a[this.curr = this.next++];
            }
         }
         ...
         public int skip(int n) {
            if (n < 0) {
               ...
               n = Math.min(n, IntArraySet.this.size - this.next);
               this.next += n;
               if (n != 0) {
         ...
         public void forEachRemaining(java.util.function.IntConsumer action) {
            int[] a = IntArraySet.this.a;

            while(this.next < IntArraySet.this.size) {
   ...
   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
      s.defaultReadObject();
      int[] a = this.a = new int[this.size];
