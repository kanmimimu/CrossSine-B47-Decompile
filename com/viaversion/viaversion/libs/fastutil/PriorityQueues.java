...
public class PriorityQueues {
   ...
   public static PriorityQueue synchronize(PriorityQueue q) {
      return new SynchronizedPriorityQueue(q);
   }

   public static PriorityQueue synchronize(PriorityQueue q, Object sync) {
   ...
   public static class SynchronizedPriorityQueue implements PriorityQueue, Serializable {
      ...
      protected SynchronizedPriorityQueue(PriorityQueue q, Object sync) {
         this.q = q;
         this.sync = sync;
      }

      protected SynchronizedPriorityQueue(PriorityQueue q) {
         this.q = q;
         this.sync = this;
      }
