...
public abstract class AbstractReferenceList extends AbstractReferenceCollection implements ReferenceList, Stack {
   ...
   public ReferenceList subList(int from, int to) {
      ...
      if (from > to) {
         ...
         return (ReferenceList)(this instanceof RandomAccess ? new ReferenceRandomAccessSubList(this, from, to) : new ReferenceSubList(this, from, to));
      }
   }
   ...
   public int hashCode() {
      ...
      K k;
      for(int s = this.size(); s-- != 0; h = 31 * h + System.identityHashCode(k)) {
         k = (K)i.next();
      }
   ...
   static final class IndexBasedSpliterator extends ObjectSpliterators.LateBindingSizeIndexBasedSpliterator {
      final ReferenceList l;

      IndexBasedSpliterator(ReferenceList l, int pos) {
         super(pos);
         this.l = l;
      }

      IndexBasedSpliterator(ReferenceList l, int pos, int maxPos) {
         super(pos, maxPos);
         this.l = l;
      }
   ...
   public static class ReferenceSubList extends AbstractReferenceList implements Serializable {
   ...
   public static class ReferenceRandomAccessSubList extends ReferenceSubList implements RandomAccess {
      private static final long serialVersionUID = -107070782945191929L;

      public ReferenceRandomAccessSubList(ReferenceList l, int from, int to) {
         super(l, from, to);
      }
