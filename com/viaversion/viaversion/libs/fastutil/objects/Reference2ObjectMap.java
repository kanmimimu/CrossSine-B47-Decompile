...
public interface Reference2ObjectMap extends Reference2ObjectFunction, Map {
   int size();
   ...
   ObjectSet reference2ObjectEntrySet();
   ...
   default void forEach(BiConsumer consumer) {
      ObjectSet<Entry<K, V>> entrySet = this.reference2ObjectEntrySet();
   ...
   default Object computeIfAbsent(Object key, Reference2ObjectFunction mappingFunction) {
   ...
   /** @deprecated */
   @Deprecated
   default Object computeObjectIfAbsentPartial(Object key, Reference2ObjectFunction mappingFunction) {
