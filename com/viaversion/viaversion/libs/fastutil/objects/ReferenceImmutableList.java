...
public class ReferenceImmutableList extends ReferenceLists.ImmutableListBase implements ReferenceList, RandomAccess, Cloneable, Serializable {
   private static final long serialVersionUID = 0L;
   static final ReferenceImmutableList EMPTY;
   ...
   public ReferenceImmutableList(Object[] a) {
      this.a = a;
   }

   public ReferenceImmutableList(Collection c) {
      this(c.isEmpty() ? emptyArray() : ObjectIterators.unwrap(c.iterator()));
   }

   public ReferenceImmutableList(ReferenceCollection c) {
      this(c.isEmpty() ? emptyArray() : ObjectIterators.unwrap(c.iterator()));
   }

   public ReferenceImmutableList(ReferenceList l) {
      this(l.isEmpty() ? emptyArray() : new Object[l.size()]);
      l.getElements(0, this.a, 0, l.size());
   }

   public ReferenceImmutableList(Object[] a, int offset, int length) {
      this(length == 0 ? emptyArray() : new Object[length]);
      System.arraycopy(a, offset, this.a, 0, length);
   }

   public ReferenceImmutableList(ObjectIterator i) {
   ...
   @SafeVarargs
   public static ReferenceImmutableList of(Object... init) {
   ...
   public static Collector toListWithExpectedSize(int expectedSize) {
      return expectedSize <= 10 ? toList() : Collector.of(new ReferenceCollections.SizeDecreasingSupplier(expectedSize, (size) -> size <= 10 ? new ReferenceArrayList() : new ReferenceArrayList(size)), ReferenceArrayList::add, ReferenceArrayList::combine, ReferenceImmutableList::convertTrustedToImmutableList);
   }
   ...
   public ObjectListIterator listIterator(final int index) {
      ...
      return new ObjectListIterator() {
         ...
         public void forEachRemaining(Consumer action) {
            K[] a = (K[])ReferenceImmutableList.this.a;
   ...
   public boolean equals(ReferenceImmutableList l) {
      if (l == this) {
         return true;
      } else if (this.a == l.a) {
         return true;
   ...
   static {
      EMPTY = new ReferenceImmutableList(ObjectArrays.EMPTY_ARRAY);
      TO_LIST_COLLECTOR = Collector.of(ReferenceArrayList::new, ReferenceArrayList::add, ReferenceArrayList::combine, ReferenceImmutableList::convertTrustedToImmutableList);
   }
   ...
   private final class Spliterator implements ObjectSpliterator {
      ...
      public void forEachRemaining(Consumer action) {
         for(K[] a = (K[])ReferenceImmutableList.this.a; this.pos < this.max; ++this.pos) {
            action.accept(a[this.pos]);
         }
   ...
   private static final class ImmutableSubList extends ReferenceLists.ImmutableListBase implements RandomAccess, Serializable {
