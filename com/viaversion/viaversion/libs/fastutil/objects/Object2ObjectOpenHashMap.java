...
public class Object2ObjectOpenHashMap extends AbstractObject2ObjectMap implements Serializable, Cloneable, Hash {
   ...
   public Object2ObjectOpenHashMap(Map m, float f) {
      this(m.size(), f);
      this.putAll(m);
   }

   public Object2ObjectOpenHashMap(Map m) {
      this(m, 0.75F);
   }

   public Object2ObjectOpenHashMap(Object2ObjectMap m, float f) {
      this(m.size(), f);
      this.putAll(m);
   }

   public Object2ObjectOpenHashMap(Object2ObjectMap m) {
      this(m, 0.75F);
   }

   public Object2ObjectOpenHashMap(Object[] k, Object[] v, float f) {
      this(k.length, f);
   ...
   public Object2ObjectOpenHashMap(Object[] k, Object[] v) {
      this(k, v, 0.75F);
   }
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection() {
            ...
            public void forEach(Consumer consumer) {
               K[] key = (K[])Object2ObjectOpenHashMap.this.key;
               V[] value = (V[])Object2ObjectOpenHashMap.this.value;
               if (Object2ObjectOpenHashMap.this.containsNullKey) {
                  consumer.accept(value[Object2ObjectOpenHashMap.this.n]);
               }
   ...
   final class MapEntry implements Object2ObjectMap.Entry, Map.Entry, Pair {
      ...
      public Object setValue(Object v) {
         V oldValue = (V)Object2ObjectOpenHashMap.this.value[this.index];
   ...
   private abstract class MapSpliterator {
      ...
      public boolean tryAdvance(Object action) {
         if (this.mustReturnNull) {
            ...
            for(K[] key = (K[])Object2ObjectOpenHashMap.this.key; this.pos < this.max; ++this.pos) {
               if (key[this.pos] != null) {
                  ++this.c;
      ...
      public boolean contains(Object o) {
         if (!(o instanceof Map.Entry)) {
            ...
            if (k == null) {
               ...
               K curr;
               int pos;
               if ((curr = (K)key[pos = HashCommon.mix(k.hashCode()) & Object2ObjectOpenHashMap.this.mask]) == null) {
                  return false;
               } else if (k.equals(curr)) {
                  return Objects.equals(Object2ObjectOpenHashMap.this.value[pos], v);
               } else {
                  while((curr = (K)key[pos = pos + 1 & Object2ObjectOpenHashMap.this.mask]) != null) {
                     if (k.equals(curr)) {
                        return Objects.equals(Object2ObjectOpenHashMap.this.value[pos], v);
                     }
                  }
   ...
   private final class KeySet extends AbstractObjectSet {
      ...
      public void forEach(Consumer consumer) {
         K[] key = (K[])Object2ObjectOpenHashMap.this.key;
         if (Object2ObjectOpenHashMap.this.containsNullKey) {
            consumer.accept(key[Object2ObjectOpenHashMap.this.n]);
         }
