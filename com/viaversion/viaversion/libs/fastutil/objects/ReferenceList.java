...
public interface ReferenceList extends List, ReferenceCollection {
   ...
   default ObjectSpliterator spliterator() {
      return (ObjectSpliterator)(this instanceof RandomAccess ? new AbstractReferenceList.IndexBasedSpliterator(this, 0) : ObjectSpliterators.asSpliterator(this.iterator(), Size64.sizeOf((Collection)this), 16464));
   }
   ...
   ReferenceList subList(int var1, int var2);
   ...
   static ReferenceList of() {
      return ReferenceImmutableList.of();
   }

   static ReferenceList of(Object e) {
      return ReferenceLists.singleton(e);
   }

   static ReferenceList of(Object e0, Object e1) {
      return ReferenceImmutableList.of(e0, e1);
   }

   static ReferenceList of(Object e0, Object e1, Object e2) {
      return ReferenceImmutableList.of(e0, e1, e2);
   }

   @SafeVarargs
   static ReferenceList of(Object... a) {
      switch (a.length) {
         case 0:
            return of();
         case 1:
