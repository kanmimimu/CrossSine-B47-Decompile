...
public class ReferenceLinkedOpenHashSet extends AbstractReferenceSortedSet implements Serializable, Cloneable, Hash {
   ...
   private static final Collector TO_SET_COLLECTOR = Collector.of(ReferenceLinkedOpenHashSet::new, ReferenceLinkedOpenHashSet::add, ReferenceLinkedOpenHashSet::combine);
   ...
   public ReferenceLinkedOpenHashSet(Collection c, float f) {
      this(c.size(), f);
      this.addAll(c);
   }
   ...
   public ReferenceLinkedOpenHashSet(ReferenceCollection c, float f) {
      this(c.size(), f);
      this.addAll(c);
   }
   ...
   public ReferenceLinkedOpenHashSet(Iterator i, float f) {
      this(16, f);
   ...
   public ReferenceLinkedOpenHashSet(Iterator i) {
      this(i, 0.75F);
   }

   public ReferenceLinkedOpenHashSet(Object[] a, int offset, int length, float f) {
   ...
   public ReferenceLinkedOpenHashSet(Object[] a, int offset, int length) {
      this(a, offset, length, 0.75F);
   }

   public ReferenceLinkedOpenHashSet(Object[] a, float f) {
      this(a, 0, a.length, f);
   }
   ...
   public static ReferenceLinkedOpenHashSet of() {
      return new ReferenceLinkedOpenHashSet();
   }

   public static ReferenceLinkedOpenHashSet of(Object e) {
      ReferenceLinkedOpenHashSet<K> result = new ReferenceLinkedOpenHashSet(1, 0.75F);
      result.add(e);
      return result;
   }

   public static ReferenceLinkedOpenHashSet of(Object e0, Object e1) {
   ...
   public static ReferenceLinkedOpenHashSet of(Object e0, Object e1, Object e2) {
   ...
   @SafeVarargs
   public static ReferenceLinkedOpenHashSet of(Object... a) {
   ...
   private ReferenceLinkedOpenHashSet combine(ReferenceLinkedOpenHashSet toAddFrom) {
   ...
   public static Collector toSetWithExpectedSize(int expectedSize) {
      return expectedSize <= 16 ? toSet() : Collector.of(new ReferenceCollections.SizeDecreasingSupplier(expectedSize, (size) -> size <= 16 ? new ReferenceLinkedOpenHashSet() : new ReferenceLinkedOpenHashSet(size)), ReferenceLinkedOpenHashSet::add, ReferenceLinkedOpenHashSet::combine);
   }
   ...
   private final class SetIterator implements ObjectListIterator {
      ...
      SetIterator(Object from) {
         if (from == null) {
            ...
            K[] key = (K[])ReferenceLinkedOpenHashSet.this.key;
      ...
      public void forEachRemaining(Consumer action) {
         ...
         for(long[] link = ReferenceLinkedOpenHashSet.this.link; this.next != -1; action.accept(key[this.curr])) {
            this.curr = this.next;
      ...
      public void remove() {
         ...
         if (this.curr == -1) {
            ...
            if (this.prev == -1) {
               ...
               long[] var6 = ReferenceLinkedOpenHashSet.this.link;
            ...
            if (this.next == -1) {
               ...
               long[] var7 = ReferenceLinkedOpenHashSet.this.link;
               int var8 = this.next;
               var7[var8] ^= (ReferenceLinkedOpenHashSet.this.link[this.next] ^ ((long)this.prev & 4294967295L) << 32) & -4294967296L;
            }
