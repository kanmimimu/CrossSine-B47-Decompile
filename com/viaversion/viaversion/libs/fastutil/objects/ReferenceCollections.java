...
public final class ReferenceCollections {
   ...
   public static ReferenceCollection synchronize(ReferenceCollection c) {
      return new SynchronizedCollection(c);
   }

   public static ReferenceCollection synchronize(ReferenceCollection c, Object sync) {
      return new SynchronizedCollection(c, sync);
   }

   public static ReferenceCollection unmodifiable(ReferenceCollection c) {
      return new UnmodifiableCollection(c);
   }

   public static ReferenceCollection asCollection(ObjectIterable iterable) {
      return (ReferenceCollection)(iterable instanceof ReferenceCollection ? (ReferenceCollection)iterable : new IterableCollection(iterable));
   }

   public abstract static class EmptyCollection extends AbstractReferenceCollection {
   ...
   public static class IterableCollection extends AbstractReferenceCollection implements Serializable {
   ...
   static class SizeDecreasingSupplier implements Supplier {
      ...
      public ReferenceCollection get() {
         ...
         return (ReferenceCollection)this.builder.apply(expectedNeededNextSize);
      }
   }
}
