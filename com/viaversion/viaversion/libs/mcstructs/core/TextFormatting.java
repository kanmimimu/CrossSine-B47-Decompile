...
public class TextFormatting {
   ...
   public static final Map COLORS = new LinkedHashMap();
   public static final Map FORMATTINGS = new LinkedHashMap();
   ...
   public static TextFormatting getByOrdinal(int ordinal) {
      return (TextFormatting)ALL.values().stream().filter((formatting) -> formatting.ordinal == ordinal).findFirst().orElse((Object)null);
   }

   @Nullable
   public static TextFormatting getByName(String name) {
      return (TextFormatting)ALL.get(name.toLowerCase());
   }
   ...
   public static TextFormatting getClosestFormattingColor(int rgb) {
      ...
      for(TextFormatting color : COLORS.values()) {
         int colorR = color.getRgbValue() >> 16 & 255;
         int colorG = color.getRgbValue() >> 8 & 255;
         int colorB = color.getRgbValue() & 255;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.type, this.name, this.code, this.rgbValue});
   }
