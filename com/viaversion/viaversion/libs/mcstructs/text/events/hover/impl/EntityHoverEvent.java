...
public class EntityHoverEvent extends AHoverEvent {
   ...
   public TextHoverEvent toLegacy(TextComponentSerializer textComponentSerializer, SNbtSerializer sNbtSerializer) {
      ...
      tag.putString("name", textComponentSerializer.serialize((ATextComponent)(this.name == null ? new StringComponent("") : this.name)));
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.entityType, this.uuid, this.name});
   }

   public String toString() {
      return ToString.of((Object)this).add("action", this.action).add("entityType", this.entityType).add("uuid", this.uuid).add("name", this.name, Objects::nonNull).toString();
   }
}
