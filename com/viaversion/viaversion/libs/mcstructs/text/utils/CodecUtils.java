...
public class CodecUtils {
   ...
   @Nullable
   public static CompoundTag optionalCompound(CompoundTag tag, String name) {
      return !tag.contains(name) ? null : requiredCompound(tag, name);
   }

   @Nullable
   public static JsonObject optionalObject(JsonObject obj, String name) {
      return !obj.has(name) ? null : requiredObject(obj, name);
   }
