...
public class LegacyStringUtils {
   ...
   public static LegacyStyle getStyleAt(String s, int position, Function formattingResolver) {
   ...
   public static String[] split(String s, String split, Function formattingResolver) {
