...
public class JsonUtils {
   ...
   public static String toSortedString(@Nullable JsonElement element, @Nullable Comparator comparator) {
      if (element == null) {
         return null;
      } else {
   ...
   public static JsonElement sort(@Nullable JsonElement element, @Nonnull Comparator comparator) {
      if (element == null) {
         return null;
