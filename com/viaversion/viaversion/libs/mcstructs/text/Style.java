...
public class Style implements ICopyable {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.parent, this.color, this.obfuscated, this.bold, this.strikethrough, this.underlined, this.italic, this.clickEvent, this.hoverEvent, this.insertion, this.font});
   }

   public String toString() {
      return ToString.of((Object)this).add("parent", this.parent, Objects::nonNull).add("color", this.color, Objects::nonNull).add("obfuscated", this.obfuscated, Objects::nonNull).add("bold", this.bold, Objects::nonNull).add("strikethrough", this.strikethrough, Objects::nonNull).add("underlined", this.underlined, Objects::nonNull).add("italic", this.italic, Objects::nonNull).add("clickEvent", this.clickEvent, Objects::nonNull).add("hoverEvent", this.hoverEvent, Objects::nonNull).add("insertion", this.insertion, Objects::nonNull).add("font", this.font, Objects::nonNull).toString();
   }
}
