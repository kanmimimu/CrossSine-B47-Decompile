...
public class TextDeserializer_v1_19_4 implements JsonDeserializer {
   public ATextComponent deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      if (json.isJsonPrimitive()) {
         ...
         if (rawComponent.has("text")) {
            ...
            String fallback = JsonUtils.getString(rawComponent, "fallback", (String)null);
            if (rawComponent.has("with")) {
               ...
               component = (new TranslationComponent(translate, new Object[0])).setFallback(fallback);
            }
