...
public class NbtStyleSerializer_v1_20_3 implements IStyleSerializer, CodecUtils_v1_20_3 {
   private final ITypedSerializer hoverEventSerializer;

   public NbtStyleSerializer_v1_20_3(Function hoverEventSerializer) {
   ...
   public Tag serialize(Style object) {
      ...
      if (object.getHoverEvent() != null) {
         out.put("hoverEvent", (Tag)this.hoverEventSerializer.serialize(object.getHoverEvent()));
      }
   ...
   public Style deserialize(Tag object) {
      if (!(object instanceof CompoundTag)) {
         ...
         if (tag.contains("hoverEvent")) {
            style.setHoverEvent((AHoverEvent)this.hoverEventSerializer.deserialize(this.requiredCompound(tag, "hoverEvent")));
         }
