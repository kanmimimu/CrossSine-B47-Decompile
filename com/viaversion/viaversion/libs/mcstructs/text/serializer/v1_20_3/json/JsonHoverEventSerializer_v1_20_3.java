...
public class JsonHoverEventSerializer_v1_20_3 implements ITypedSerializer, CodecUtils_v1_20_3 {
   ...
   public JsonHoverEventSerializer_v1_20_3(TextComponentCodec codec, ITypedSerializer textSerializer, SNbtSerializer sNbtSerializer) {
      this.codec = codec;
         ...
         if (action == null) {
            ...
            switch (action) {
               ...
               case SHOW_ITEM:
                  ...
                  } else if (!obj.has("contents") || !this.isObject(obj.get("contents"))) {
   ...
   protected UUID getUUID(JsonElement element) {
