...
public class JsonStyleSerializer_v1_20_3 implements IStyleSerializer, CodecUtils_v1_20_3 {
   private final ITypedSerializer hoverEventSerializer;

   public JsonStyleSerializer_v1_20_3(Function hoverEventSerializer) {
      this.hoverEventSerializer = (ITypedSerializer)hoverEventSerializer.apply(this);
   }
   ...
   public JsonElement serialize(Style object) {
      ...
      if (object.getHoverEvent() != null) {
         out.add("hoverEvent", (JsonElement)this.hoverEventSerializer.serialize(object.getHoverEvent()));
      }
   ...
   public Style deserialize(JsonElement object) {
      if (!object.isJsonObject()) {
         ...
         if (obj.has("color")) {
            ...
            if (formatting.isRGBColor() && (formatting.getRgbValue() < 0 || formatting.getRgbValue() > 16777215)) {
         ...
         if (obj.has("clickEvent")) {
            ...
            if (!action.isUserDefinable()) {
               throw new IllegalArgumentException("Click event action is not user definable: " + action);
            }
         ...
         if (obj.has("hoverEvent")) {
            style.setHoverEvent((AHoverEvent)this.hoverEventSerializer.deserialize(this.requiredObject(obj, "hoverEvent")));
         }
