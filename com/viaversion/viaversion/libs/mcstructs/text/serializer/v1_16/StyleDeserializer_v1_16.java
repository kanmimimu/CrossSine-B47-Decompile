...
public class StyleDeserializer_v1_16 implements JsonDeserializer {
      ...
      if (!json.isJsonObject()) {
         ...
         if (rawStyle == null) {
            ...
            if (rawStyle.has("insertion")) {
               style.setInsertion(JsonUtils.getString(rawStyle, "insertion", (String)null));
            }
            ...
            if (rawStyle.has("hoverEvent")) {
               ...
               AHoverEvent hoverEvent = (AHoverEvent)context.deserialize(rawHoverEvent, AHoverEvent.class);
