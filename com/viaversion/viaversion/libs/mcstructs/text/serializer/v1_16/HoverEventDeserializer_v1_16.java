...
public class HoverEventDeserializer_v1_16 implements JsonDeserializer {
   ...
   public AHoverEvent deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
      if (!json.isJsonObject()) {
         ...
         if (rawHoverEvent == null) {
            ...
            String rawAction = JsonUtils.getString(rawHoverEvent, "action", (String)null);
            if (rawAction == null) {
               return null;
            } else {
      ...
      switch (action) {
         ...
         case SHOW_ITEM:
            if (contents.isJsonPrimitive()) {
               return new ItemHoverEvent(action, Identifier.of(contents.getAsString()), 1, (CompoundTag)null);
            } else {
               ...
               return new ItemHoverEvent(action, item, count, (CompoundTag)null);
            }
         case SHOW_ENTITY:
