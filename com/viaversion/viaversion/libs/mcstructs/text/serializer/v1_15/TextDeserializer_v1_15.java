...
public class TextDeserializer_v1_15 implements JsonDeserializer {
      ...
      if (json.isJsonPrimitive()) {
         ...
         if (rawComponent.has("text")) {
            ...
            if (rawComponent.has("block")) {
               ...
               component = new StorageNbtComponent(nbt, interpret, (ATextComponent)null, Identifier.of(JsonUtils.getString(rawComponent, "storage")));
            }
         }
