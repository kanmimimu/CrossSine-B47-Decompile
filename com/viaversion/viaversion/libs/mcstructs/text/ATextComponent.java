...
public abstract class ATextComponent implements ICopyable {
   private final List siblings = new ArrayList();
   ...
   public ATextComponent forEach(Consumer consumer) {
   ...
   public ATextComponent modifyStyle(Consumer styleConsumer) {
   ...
   public ATextComponent putMetaCopy(ATextComponent component) {
