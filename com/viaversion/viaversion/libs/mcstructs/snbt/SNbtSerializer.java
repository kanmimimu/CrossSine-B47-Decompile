...
public class SNbtSerializer {
   public static final SNbtSerializer V1_7 = new SNbtSerializer(SNbtSerializer_v1_7::new, SNbtDeserializer_v1_7::new);
   public static final SNbtSerializer V1_8 = new SNbtSerializer(SNbtSerializer_v1_8::new, SNbtDeserializer_v1_8::new);
   public static final SNbtSerializer V1_12 = new SNbtSerializer(SNbtSerializer_v1_12::new, SNbtDeserializer_v1_12::new);
   public static final SNbtSerializer V1_13 = new SNbtSerializer(SNbtSerializer_v1_12::new, SNbtDeserializer_v1_13::new);
   public static final SNbtSerializer V1_14 = new SNbtSerializer(SNbtSerializer_v1_14::new, SNbtDeserializer_v1_14::new);
   public static final SNbtSerializer LATEST;
   private final Supplier serializerSupplier;
   private final Supplier deserializerSupplier;
   private ISNbtSerializer serializer;
   private ISNbtDeserializer deserializer;

   public SNbtSerializer(Supplier serializerSupplier, Supplier deserializerSupplier) {
   ...
   public ISNbtSerializer getSerializer() {
      if (this.serializer == null) {
         this.serializer = (ISNbtSerializer)this.serializerSupplier.get();
      }

      return this.serializer;
   }

   public ISNbtDeserializer getDeserializer() {
      if (this.deserializer == null) {
         this.deserializer = (ISNbtDeserializer)this.deserializerSupplier.get();
      }
   ...
   @Nullable
   public Tag tryDeserialize(String s) {
      try {
