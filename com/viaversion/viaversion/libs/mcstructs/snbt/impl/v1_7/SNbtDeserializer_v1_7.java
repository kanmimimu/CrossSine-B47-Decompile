...
public class SNbtDeserializer_v1_7 implements ISNbtDeserializer {
   ...
   private void checkBrackets(String s, char close, Stack brackets) throws SNbtDeserializeException {
   ...
   private String quotesToString(Stack quotes) {
