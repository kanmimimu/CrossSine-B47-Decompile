...
public interface EntityTracker {
   ...
   @Nullable TrackedEntity entity(int var1);

   @Nullable EntityType entityType(int var1);

   void removeEntity(int var1);

   void clearEntities();

   @Nullable StoredEntityData entityData(int var1);

   @Nullable StoredEntityData entityDataIfPresent(int var1);
   ...
   @Nullable DimensionData dimensionData(String var1);

   @Nullable DimensionData dimensionData(int var1);

   void setDimensions(Map var1);
}
