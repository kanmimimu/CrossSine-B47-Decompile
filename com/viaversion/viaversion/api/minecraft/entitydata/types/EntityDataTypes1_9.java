...
public enum EntityDataTypes1_9 implements EntityDataType {
   ...
   // $FF: synthetic method
   private static EntityDataTypes1_9[] $values() {
      return new EntityDataTypes1_9[]{BYTE, VAR_INT, FLOAT, STRING, COMPONENT, ITEM, BOOLEAN, ROTATIONS, BLOCK_POSITION, OPTIONAL_BLOCK_POSITION, DIRECTION, OPTIONAL_UUID, OPTIONAL_BLOCK_STATE};
   }
}
