...
public class EntityTypes1_9 {
   public static EntityType getTypeFromId(int typeId, boolean object) {
      EntityType type;
      if (object) {
         type = EntityTypes1_9.ObjectType.getEntityType(typeId);
      } else {
         type = EntityTypes1_9.EntityType.findById(typeId);
      }

      if (type == null) {
         Via.getPlatform().getLogger().severe("Could not find 1.9 type id " + typeId + " objectType=" + object);
         return EntityTypes1_9.EntityType.ENTITY;
      } else {
         return type;
      }
   }
   ...
   public static enum ObjectType implements com.viaversion.viaversion.api.minecraft.entities.ObjectType {
      BOAT(1, EntityTypes1_9.EntityType.BOAT),
      ITEM(2, EntityTypes1_9.EntityType.ITEM),
      AREA_EFFECT_CLOUD(3, EntityTypes1_9.EntityType.AREA_EFFECT_CLOUD),
      MINECART(10, EntityTypes1_9.EntityType.MINECART),
      TNT_PRIMED(50, EntityTypes1_9.EntityType.TNT),
      ENDER_CRYSTAL(51, EntityTypes1_9.EntityType.END_CRYSTAL),
      TIPPED_ARROW(60, EntityTypes1_9.EntityType.ARROW),
      SNOWBALL(61, EntityTypes1_9.EntityType.SNOWBALL),
      EGG(62, EntityTypes1_9.EntityType.EGG),
      FIREBALL(63, EntityTypes1_9.EntityType.FIREBALL),
      SMALL_FIREBALL(64, EntityTypes1_9.EntityType.SMALL_FIREBALL),
      ENDER_PEARL(65, EntityTypes1_9.EntityType.ENDER_PEARL),
      WITHER_SKULL(66, EntityTypes1_9.EntityType.WITHER_SKULL),
      SHULKER_BULLET(67, EntityTypes1_9.EntityType.SHULKER_BULLET),
      FALLING_BLOCK(70, EntityTypes1_9.EntityType.FALLING_BLOCK),
      ITEM_FRAME(71, EntityTypes1_9.EntityType.ITEM_FRAME),
      EYE_OF_ENDER(72, EntityTypes1_9.EntityType.EYE_OF_ENDER),
      POTION(73, EntityTypes1_9.EntityType.POTION),
      EXPERIENCE_BOTTLE(75, EntityTypes1_9.EntityType.EXPERIENCE_BOTTLE),
      FIREWORK_ROCKET(76, EntityTypes1_9.EntityType.FIREWORK_ROCKET),
      LEASH(77, EntityTypes1_9.EntityType.LEASH_KNOT),
      ARMOR_STAND(78, EntityTypes1_9.EntityType.ARMOR_STAND),
      FISHIHNG_HOOK(90, EntityTypes1_9.EntityType.FISHING_HOOK),
      SPECTRAL_ARROW(91, EntityTypes1_9.EntityType.SPECTRAL_ARROW),
      DRAGON_FIREBALL(93, EntityTypes1_9.EntityType.DRAGON_FIREBALL);
