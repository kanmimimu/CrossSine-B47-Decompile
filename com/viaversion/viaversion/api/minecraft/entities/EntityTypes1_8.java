...
public class EntityTypes1_8 {
   public static EntityType getTypeFromId(int typeId, boolean object) {
      EntityType type;
      if (object) {
         type = EntityTypes1_8.ObjectType.getEntityType(typeId);
      } else {
         type = EntityTypes1_8.EntityType.findById(typeId);
      }

      if (type == null) {
         Via.getPlatform().getLogger().severe("Could not find 1.8 type id " + typeId + " objectType=" + object);
         return EntityTypes1_8.EntityType.ENTITY;
      } else {
         return type;
      }
   }
   ...
   public static enum ObjectType implements com.viaversion.viaversion.api.minecraft.entities.ObjectType {
      BOAT(1, EntityTypes1_8.EntityType.BOAT),
      ITEM(2, EntityTypes1_8.EntityType.ITEM),
      MINECART(10, EntityTypes1_8.EntityType.MINECART),
      TNT_PRIMED(50, EntityTypes1_8.EntityType.TNT),
      ENDER_CRYSTAL(51, EntityTypes1_8.EntityType.END_CRYSTAL),
      TIPPED_ARROW(60, EntityTypes1_8.EntityType.ARROW),
      SNOWBALL(61, EntityTypes1_8.EntityType.SNOWBALL),
      EGG(62, EntityTypes1_8.EntityType.EGG),
      FIREBALL(63, EntityTypes1_8.EntityType.FIREBALL),
      SMALL_FIREBALL(64, EntityTypes1_8.EntityType.SMALL_FIREBALL),
      ENDER_PEARL(65, EntityTypes1_8.EntityType.ENDER_PEARL),
      WITHER_SKULL(66, EntityTypes1_8.EntityType.WITHER_SKULL),
      FALLING_BLOCK(70, EntityTypes1_8.EntityType.FALLING_BLOCK),
      ITEM_FRAME(71, EntityTypes1_8.EntityType.ITEM_FRAME),
      EYE_OF_ENDER(72, EntityTypes1_8.EntityType.EYE_OF_ENDER),
      POTION(73, EntityTypes1_8.EntityType.POTION),
      EXPERIENCE_BOTTLE(75, EntityTypes1_8.EntityType.EXPERIENCE_BOTTLE),
      FIREWORK_ROCKET(76, EntityTypes1_8.EntityType.FIREWORK_ROCKET),
      LEASH(77, EntityTypes1_8.EntityType.LEASH_KNOT),
      ARMOR_STAND(78, EntityTypes1_8.EntityType.ARMOR_STAND),
      FISHIHNG_HOOK(90, EntityTypes1_8.EntityType.FISHING_HOOK);
      ...
      static ObjectType[] $values() {
         return new ObjectType[]{BOAT, ITEM, MINECART, TNT_PRIMED, ENDER_CRYSTAL, TIPPED_ARROW, SNOWBALL, EGG, FIREBALL, SMALL_FIREBALL, ENDER_PEARL, WITHER_SKULL, FALLING_BLOCK, ITEM_FRAME, EYE_OF_ENDER, POTION, EXPERIENCE_BOTTLE, FIREWORK_ROCKET, LEASH, ARMOR_STAND, FISHIHNG_HOOK};
      }
