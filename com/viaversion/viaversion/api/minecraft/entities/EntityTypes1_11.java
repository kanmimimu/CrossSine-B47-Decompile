...
public class EntityTypes1_11 {
   public static EntityType getTypeFromId(int typeId, boolean object) {
      EntityType type;
      if (object) {
         type = EntityTypes1_11.ObjectType.getEntityType(typeId);
      } else {
   ...
   public static enum ObjectType implements com.viaversion.viaversion.api.minecraft.entities.ObjectType {
      ...
      ITEM(2, EntityTypes1_11.EntityType.ITEM),
      AREA_EFFECT_CLOUD(3, EntityTypes1_11.EntityType.AREA_EFFECT_CLOUD),
      MINECART(10, EntityTypes1_11.EntityType.MINECART),
      TNT_PRIMED(50, EntityTypes1_11.EntityType.TNT),
      ENDER_CRYSTAL(51, EntityTypes1_11.EntityType.END_CRYSTAL),
      ...
      LLAMA_SPIT(68, EntityTypes1_11.EntityType.LLAMA_SPIT),
      FALLING_BLOCK(70, EntityTypes1_11.EntityType.FALLING_BLOCK),
      ITEM_FRAME(71, EntityTypes1_11.EntityType.ITEM_FRAME),
      EYE_OF_ENDER(72, EntityTypes1_11.EntityType.EYE_OF_ENDER),
      POTION(73, EntityTypes1_11.EntityType.POTION),
      EXPERIENCE_BOTTLE(75, EntityTypes1_11.EntityType.EXPERIENCE_BOTTLE),
      FIREWORK_ROCKET(76, EntityTypes1_11.EntityType.FIREWORK_ROCKET),
      LEASH(77, EntityTypes1_11.EntityType.LEASH_KNOT),
      ARMOR_STAND(78, EntityTypes1_11.EntityType.ARMOR_STAND),
      EVOKER_FANGS(79, EntityTypes1_11.EntityType.EVOKER_FANGS),
