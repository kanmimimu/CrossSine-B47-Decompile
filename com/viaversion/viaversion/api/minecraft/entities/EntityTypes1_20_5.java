...
public enum EntityTypes1_20_5 implements EntityType {
   ...
   ABSTRACT_WIND_CHARGE(PROJECTILE, (String)null),
   ...
   private EntityTypes1_20_5(EntityType parent) {
      this.parent = parent;
      this.identifier = Key.namespaced(this.name().toLowerCase(Locale.ROOT));
   }

   private EntityTypes1_20_5(EntityType parent, String identifier) {
      this.parent = parent;
