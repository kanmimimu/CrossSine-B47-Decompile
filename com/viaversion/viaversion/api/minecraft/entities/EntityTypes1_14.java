...
public enum EntityTypes1_14 implements EntityType {
   ...
   private EntityTypes1_14(EntityType parent) {
      this.parent = parent;
      this.identifier = Key.namespaced(this.name().toLowerCase(Locale.ROOT));
   }

   private EntityTypes1_14(EntityType parent, String identifier) {
      this.parent = parent;
