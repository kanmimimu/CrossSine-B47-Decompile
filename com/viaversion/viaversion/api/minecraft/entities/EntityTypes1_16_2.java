...
public enum EntityTypes1_16_2 implements EntityType {
   ...
   private EntityTypes1_16_2(EntityType parent) {
      this.parent = parent;
      this.identifier = Key.namespaced(this.name().toLowerCase(Locale.ROOT));
   }

   private EntityTypes1_16_2(EntityType parent, String identifier) {
      this.parent = parent;
