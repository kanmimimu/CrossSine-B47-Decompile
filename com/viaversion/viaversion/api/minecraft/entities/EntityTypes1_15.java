...
public enum EntityTypes1_15 implements EntityType {
   ...
   private EntityTypes1_15(EntityType parent) {
      this.parent = parent;
      this.identifier = Key.namespaced(this.name().toLowerCase(Locale.ROOT));
   }

   private EntityTypes1_15(EntityType parent, String identifier) {
      this.parent = parent;
