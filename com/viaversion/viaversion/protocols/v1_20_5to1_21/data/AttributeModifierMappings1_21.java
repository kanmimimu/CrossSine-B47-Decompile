...
public final class AttributeModifierMappings1_21 {
   private static final Map ATTRIBUTE_MODIFIER_IDS = new HashMap();
   private static final Map ATTRIBUTE_MODIFIER_INVERSE_IDS = new HashMap();
   private static final BiMap ATTRIBUTE_MODIFIER_NAMES;

   public static @Nullable String uuidToId(UUID uuid) {
      return (String)ATTRIBUTE_MODIFIER_IDS.get(uuid);
   }

   public static @Nullable UUID idToUuid(String id) {
      return (UUID)ATTRIBUTE_MODIFIER_INVERSE_IDS.get(Key.stripMinecraftNamespace(id));
   }

   public static @Nullable String nameToId(String name) {
      return (String)ATTRIBUTE_MODIFIER_NAMES.get(name);
   }

   public static @Nullable String idToName(String id) {
      return (String)ATTRIBUTE_MODIFIER_NAMES.inverse().get(id);
   }
   ...
   static {
      ...
      var2.put("Zombie reinforcement caller charge", "reinforcement_caller_charge");
      var2.put("Zombie reinforcement callee charge", "reinforcement_callee_charge");
      var2.put("Leader zombie bonus", "leader_zombie_bonus");
      var2.put("Random zombie-spawn bonus", "zombie_random_spawn_bonus");
      var2.put("Random spawn bonus", "random_spawn_bonus");
      ATTRIBUTE_MODIFIER_NAMES = HashBiMap.create(Collections.unmodifiableMap(var2));
