         ...
         public void register() {
            ...
            this.handler((wrapper) -> {
               ...
               if (id == 2000) {
                  ...
                  wrapper.set(Types.INT, 1, protocol.getMappingData().getNewItemId((Integer)wrapper.get(Types.INT, 1)));
               } else if (id == 2001) {
                  wrapper.set(Types.INT, 1, protocol.getMappingData().getNewBlockStateId((Integer)wrapper.get(Types.INT, 1)));
               }
