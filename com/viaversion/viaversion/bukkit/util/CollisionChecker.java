...
public class CollisionChecker {
   static final CollisionChecker INSTANCE;
   final Method GET_ENTITY_HANDLE;
   final Method GET_ENTITY_BB;
   final Method GET_BLOCK_BY_ID;
   final Method GET_WORLD_HANDLE;
   final Method GET_BLOCK_TYPE;
   final Method GET_COLLISIONS;
   final Method SET_POSITION;
   final Object BLOCK_POSITION;

   CollisionChecker() throws ReflectiveOperationException {
   ...
   private static class DummyList extends AbstractList {
      boolean any;
      ...
      public void add(int idx, Object el) {
         this.any = true;
      }
