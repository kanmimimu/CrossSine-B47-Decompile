...
public class BukkitBlockConnectionProvider extends BlockConnectionProvider {
   ...
   public Chunk getChunk(World world, int x, int z) {
      return this.lastChunk != null && this.lastChunk.getWorld().equals(world) && this.lastChunk.getX() == x && this.lastChunk.getZ() == z ? this.lastChunk : (this.lastChunk = world.getChunkAt(x, z));
   }
}
