...
public class ItemList1_6 {
   public static final List itemList = Lists.newArrayList();
   ...
   public static Item1_6 getByID(int itemID) {
   ...
   public static Item1_6 getByName(String name) {
      for(Item1_6 item : itemList) {
   ...
   public static final class Item1_6 {
      final int itemId;
      final String name;
      final int maxDamage;
      ...
      public boolean equals(Object var1) {
         if (this == var1) {
            return true;
         } else if (!(var1 instanceof Item1_6)) {
            return false;
         } else {
            Item1_6 var2 = (Item1_6)var1;
            return this.itemId == var2.itemId && Objects.equals(this.name, var2.name) && this.maxDamage == var2.maxDamage && this.hasSubTypes == var2.hasSubTypes;
         }
      }

      public int hashCode() {
         return (((0 * 31 + Integer.hashCode(this.itemId)) * 31 + Objects.hashCode(this.name)) * 31 + Integer.hashCode(this.maxDamage)) * 31 + Boolean.hashCode(this.hasSubTypes);
      }

      public String toString() {
         return String.format("%s[itemId=%s, name=%s, maxDamage=%s, hasSubTypes=%s]", this.getClass().getSimpleName(), Integer.toString(this.itemId), Objects.toString(this.name), Integer.toString(this.maxDamage), Boolean.toString(this.hasSubTypes));
      }
   }
}
