...
public class BlockList1_6 {
   public static final List blockList = Lists.newArrayList();
   ...
   public static Block1_6 getByID(int id) {
   ...
   public static Block1_6 getByName(String name) {
      for(Block1_6 block : blockList) {
   ...
   public static final class Block1_6 {
      ...
      public boolean equals(Object var1) {
         if (this == var1) {
            return true;
         } else if (!(var1 instanceof Block1_6)) {
            return false;
         } else {
            Block1_6 var2 = (Block1_6)var1;
            return this.blockId == var2.blockId && Objects.equals(this.name, var2.name);
         }
      }
      ...
      public String toString() {
         return String.format("%s[blockId=%s, name=%s]", this.getClass().getSimpleName(), Integer.toString(this.blockId), Objects.toString(this.name));
      }
   }
}
