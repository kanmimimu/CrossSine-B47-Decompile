...
public enum ClientboundPacketsc0_20a implements ClientboundPacketType, PreNettyPacketType {
   ...
   private ClientboundPacketsc0_20a(int id, BiConsumer packetReader) {
      this.id = id;
   ...
   // $FF: synthetic method
   private static ClientboundPacketsc0_20a[] $values() {
      return new ClientboundPacketsc0_20a[]{LOGIN, KEEP_ALIVE, LEVEL_INIT, LEVEL_DATA, LEVEL_FINALIZE, BLOCK_UPDATE, ADD_PLAYER, TELEPORT_ENTITY, MOVE_ENTITY_POS_ROT, MOVE_ENTITY_POS, MOVE_ENTITY_ROT, REMOVE_ENTITIES, CHAT, DISCONNECT};
   }
