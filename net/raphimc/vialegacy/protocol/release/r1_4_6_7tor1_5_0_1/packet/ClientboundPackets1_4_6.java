package net.raphimc.vialegacy.protocol.release.r1_4_6_7tor1_5_0_1.packet;
...
public enum ClientboundPackets1_4_6 implements ClientboundPacketType, PreNettyPacketType {
   ...
   private static final ClientboundPackets1_4_6[] REGISTRY = new ClientboundPackets1_4_6[256];
   private final int id;
   private final BiConsumer packetReader;

   public static ClientboundPackets1_4_6 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPackets1_4_6(int id, BiConsumer packetReader) {
      this.id = id;
