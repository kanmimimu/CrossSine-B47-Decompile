package net.raphimc.vialegacy.protocol.release.r1_4_4_5tor1_4_6_7.packet;
...
public enum ClientboundPackets1_4_4 implements ClientboundPacketType, PreNettyPacketType {
   ...
   public static ClientboundPackets1_4_4 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPackets1_4_4(int id, BiConsumer packetReader) {
      this.id = id;
