...
public enum ServerboundPackets1_3_1 implements ServerboundPacketType, PreNettyPacketType {
   ...
   private ServerboundPackets1_3_1(int id, BiConsumer packetReader) {
      this.id = id;
