...
public enum ClientboundPackets1_3_1 implements ClientboundPacketType, PreNettyPacketType {
   ...
   private static final ClientboundPackets1_3_1[] REGISTRY = new ClientboundPackets1_3_1[256];
   private final int id;
   private final BiConsumer packetReader;

   public static ClientboundPackets1_3_1 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPackets1_3_1(int id, BiConsumer packetReader) {
      this.id = id;
