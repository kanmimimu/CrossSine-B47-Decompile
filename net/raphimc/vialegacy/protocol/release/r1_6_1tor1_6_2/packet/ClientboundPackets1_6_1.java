package net.raphimc.vialegacy.protocol.release.r1_6_1tor1_6_2.packet;
...
public enum ClientboundPackets1_6_1 implements ClientboundPacketType, PreNettyPacketType {
   ...
   public static ClientboundPackets1_6_1 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPackets1_6_1(int id, BiConsumer packetReader) {
      this.id = id;
