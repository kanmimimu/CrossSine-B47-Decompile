...
public class TextRewriter {
   private static final Object2ObjectMap TRANSLATIONS = new Object2ObjectOpenHashMap(37, 0.99F);
   ...
   public static String toClient(String text) {
      ...
      component = TextUtils.replace(component, (c) -> c instanceof StringComponent ? LegacyStringDeserializer.parse(c.asSingleString(), true).setParentStyle(c.getStyle()) : c);
      TextUtils.iterateAll(component, (c) -> {
         if (c instanceof TranslationComponent) {
            TranslationComponent translationComponent = (TranslationComponent)c;
