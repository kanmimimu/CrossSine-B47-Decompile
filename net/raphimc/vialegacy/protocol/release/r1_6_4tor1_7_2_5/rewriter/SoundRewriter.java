...
public class SoundRewriter {
   private static final Object2ObjectMap SOUNDS = new Object2ObjectOpenHashMap(196, 0.99F);

   public static String map(String sound) {
      return (String)SOUNDS.get(sound);
   }
