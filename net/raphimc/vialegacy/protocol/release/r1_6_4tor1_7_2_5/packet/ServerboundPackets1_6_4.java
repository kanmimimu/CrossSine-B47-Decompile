...
public enum ServerboundPackets1_6_4 implements ServerboundPacketType, PreNettyPacketType {
   ...
   private ServerboundPackets1_6_4(int id, BiConsumer packetReader) {
      this.id = id;
