...
public class ChunkTracker extends AbstractChunkTracker {
   private static final Map SOLID_BLOCKS = new HashMap();
      ...
      if (this.b173 && block.getId() == BlockList1_6.chest.blockId()) {
         ...
         if (rot1 != BlockList1_6.chest.blockId() && rot2 != BlockList1_6.chest.blockId()) {
            if (rot3 != BlockList1_6.chest.blockId() && rot4 != BlockList1_6.chest.blockId()) {
               if ((Boolean)SOLID_BLOCKS.get(rot2) && !(Boolean)SOLID_BLOCKS.get(rot1)) {
                  blockData = 2;
               }

               if ((Boolean)SOLID_BLOCKS.get(rot3) && !(Boolean)SOLID_BLOCKS.get(rot4)) {
                  blockData = 5;
               }

               if ((Boolean)SOLID_BLOCKS.get(rot4) && !(Boolean)SOLID_BLOCKS.get(rot3)) {
                  blockData = 4;
               }
            } else if (((Boolean)SOLID_BLOCKS.get(rot2) || (Boolean)SOLID_BLOCKS.get(rot6)) && !(Boolean)SOLID_BLOCKS.get(rot1) && !(Boolean)SOLID_BLOCKS.get(rot5)) {
               blockData = 2;
            }
         } else {
            blockData = 5;
            ...
            if (((Boolean)SOLID_BLOCKS.get(rot4) || (Boolean)SOLID_BLOCKS.get(rot6)) && !(Boolean)SOLID_BLOCKS.get(rot3) && !(Boolean)SOLID_BLOCKS.get(rot5)) {
               blockData = 4;
            }
         }
