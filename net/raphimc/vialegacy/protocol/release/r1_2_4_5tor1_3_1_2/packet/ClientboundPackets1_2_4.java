...
public enum ClientboundPackets1_2_4 implements ClientboundPacketType, PreNettyPacketType {
   ...
   private ClientboundPackets1_2_4(int id, BiConsumer packetReader) {
      this.id = id;
