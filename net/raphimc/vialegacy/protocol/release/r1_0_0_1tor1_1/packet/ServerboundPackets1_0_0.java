...
public enum ServerboundPackets1_0_0 implements ServerboundPacketType, PreNettyPacketType {
   ...
   private ServerboundPackets1_0_0(int id, BiConsumer packetReader) {
      this.id = id;
   ...
   // $FF: synthetic method
   private static ServerboundPackets1_0_0[] $values() {
      return new ServerboundPackets1_0_0[]{KEEP_ALIVE, LOGIN, HANDSHAKE, CHAT, INTERACT, RESPAWN, MOVE_PLAYER_STATUS_ONLY, MOVE_PLAYER_POS, MOVE_PLAYER_ROT, MOVE_PLAYER_POS_ROT, PLAYER_ACTION, USE_ITEM_ON, SET_CARRIED_ITEM, SWING, PLAYER_COMMAND, POSITION, CONTAINER_CLOSE, CONTAINER_CLICK, CONTAINER_ACK, SET_CREATIVE_MODE_SLOT, CONTAINER_BUTTON_CLICK, SIGN_UPDATE, SERVER_PING, DISCONNECT};
   }
