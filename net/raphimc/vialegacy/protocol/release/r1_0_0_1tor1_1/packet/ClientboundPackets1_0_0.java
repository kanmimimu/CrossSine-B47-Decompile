...
public enum ClientboundPackets1_0_0 implements ClientboundPacketType, PreNettyPacketType {
   ...
   private static final ClientboundPackets1_0_0[] REGISTRY = new ClientboundPackets1_0_0[256];
   private final int id;
   private final BiConsumer packetReader;

   public static ClientboundPackets1_0_0 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPackets1_0_0(int id, BiConsumer packetReader) {
      this.id = id;
