...
public enum ServerboundPackets1_2_1 implements ServerboundPacketType, PreNettyPacketType {
   ...
   public static ServerboundPackets1_2_1 getPacket(int id) {
      return REGISTRY[id];
   }

   private ServerboundPackets1_2_1(int id, BiConsumer packetReader) {
      this.id = id;
   ...
   // $FF: synthetic method
   private static ServerboundPackets1_2_1[] $values() {
      return new ServerboundPackets1_2_1[]{KEEP_ALIVE, LOGIN, HANDSHAKE, CHAT, INTERACT, RESPAWN, MOVE_PLAYER_STATUS_ONLY, MOVE_PLAYER_POS, MOVE_PLAYER_ROT, MOVE_PLAYER_POS_ROT, PLAYER_ACTION, USE_ITEM_ON, SET_CARRIED_ITEM, SWING, PLAYER_COMMAND, CONTAINER_CLOSE, CONTAINER_CLICK, CONTAINER_ACK, SET_CREATIVE_MODE_SLOT, CONTAINER_BUTTON_CLICK, SIGN_UPDATE, CUSTOM_PAYLOAD, SERVER_PING, DISCONNECT};
   }
