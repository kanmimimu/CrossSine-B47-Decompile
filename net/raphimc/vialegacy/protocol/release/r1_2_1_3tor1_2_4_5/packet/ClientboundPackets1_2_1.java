...
public enum ClientboundPackets1_2_1 implements ClientboundPacketType, PreNettyPacketType {
   ...
   public static ClientboundPackets1_2_1 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPackets1_2_1(int id, BiConsumer packetReader) {
      this.id = id;
   ...
   // $FF: synthetic method
   private static ClientboundPackets1_2_1[] $values() {
      return new ClientboundPackets1_2_1[]{KEEP_ALIVE, LOGIN, HANDSHAKE, CHAT, SET_TIME, SET_EQUIPPED_ITEM, SET_DEFAULT_SPAWN_POSITION, SET_HEALTH, RESPAWN, MOVE_PLAYER_STATUS_ONLY, MOVE_PLAYER_POS, MOVE_PLAYER_ROT, PLAYER_POSITION, PLAYER_SLEEP, ANIMATE, ADD_PLAYER, SPAWN_ITEM, TAKE_ITEM_ENTITY, ADD_ENTITY, ADD_MOB, ADD_PAINTING, ADD_EXPERIENCE_ORB, SET_ENTITY_MOTION, REMOVE_ENTITIES, MOVE_ENTITY, MOVE_ENTITY_POS, MOVE_ENTITY_ROT, MOVE_ENTITY_POS_ROT, TELEPORT_ENTITY, ROTATE_HEAD, ENTITY_EVENT, SET_ENTITY_LINK, SET_ENTITY_DATA, UPDATE_MOB_EFFECT, REMOVE_MOB_EFFECT, SET_EXPERIENCE, PRE_CHUNK, LEVEL_CHUNK, CHUNK_BLOCKS_UPDATE, BLOCK_UPDATE, BLOCK_EVENT, EXPLODE, LEVEL_EVENT, GAME_EVENT, ADD_GLOBAL_ENTITY, OPEN_SCREEN, CONTAINER_CLOSE, CONTAINER_SET_SLOT, CONTAINER_SET_CONTENT, CONTAINER_SET_DATA, CONTAINER_ACK, SET_CREATIVE_MODE_SLOT, UPDATE_SIGN, MAP_ITEM_DATA, BLOCK_ENTITY_DATA, AWARD_STATS, PLAYER_INFO, CUSTOM_PAYLOAD, DISCONNECT};
   }
