...
public enum EntityDataIndex1_7_6 {
   ...
   ENDERMAN_CARRIED_BLOCK(EntityTypes1_8.EntityType.ENDERMAN, 16, EntityDataTypes1_7_6.BYTE, EntityDataTypes1_8.SHORT),
   ENDERMAN_CARRIED_BLOCK_DATA(EntityTypes1_8.EntityType.ENDERMAN, 17, EntityDataTypes1_7_6.BYTE, EntityDataTypes1_8.BYTE),
   ...
   GHAST_IS_POWERED(EntityTypes1_8.EntityType.GHAST, 17, (EntityDataTypes1_7_6)null, EntityDataTypes1_8.BYTE),
   ...
   GUARDIAN_FLAGS(EntityTypes1_8.EntityType.GUARDIAN, 16, (EntityDataTypes1_7_6)null, EntityDataTypes1_8.BYTE),
   GUARDIAN_TARGET(EntityTypes1_8.EntityType.GUARDIAN, 17, (EntityDataTypes1_7_6)null, EntityDataTypes1_8.INT),
   ...
   private EntityDataIndex1_7_6(EntityTypes1_8.EntityType entityType, int oldIndex, EntityDataTypes1_7_6 oldType, EntityDataTypes1_8 newType) {
   ...
   private EntityDataIndex1_7_6(EntityTypes1_8.EntityType entityType, int oldIndex, EntityDataTypes1_7_6 oldType, int newIndex, EntityDataTypes1_8 newType) {
      this.entityType = entityType;
      this.oldIndex = oldIndex;
      this.oldType = oldType;
   ...
   private static Optional getIndex(EntityTypes1_8.EntityType type, int index) {
      Pair<EntityTypes1_8.EntityType, Integer> pair = new Pair(type, index);
      return Optional.ofNullable((EntityDataIndex1_7_6)ENTITY_DATA_REWRITES.get(pair));
   }
   ...
   public static EntityDataIndex1_7_6 searchIndex(EntityTypes1_8.EntityType type, int index) {
      ...
      do {
         ...
         if (optMeta.isPresent()) {
            return (EntityDataIndex1_7_6)optMeta.get();
         }
