...
public enum ClientboundPackets1_1 implements ClientboundPacketType, PreNettyPacketType {
   ...
   public static ClientboundPackets1_1 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPackets1_1(int id, BiConsumer packetReader) {
      this.id = id;
