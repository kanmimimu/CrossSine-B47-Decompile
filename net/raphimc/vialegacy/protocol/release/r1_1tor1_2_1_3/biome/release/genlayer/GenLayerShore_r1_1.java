   ...
   public int[] getInts(int i, int j, int k, int l) {
      ...
      for(int i1 = 0; i1 < l; ++i1) {
         for(int j1 = 0; j1 < k; ++j1) {
            ...
            } else if (k1 != NewBiomeGenBase.ocean.biomeID && k1 != NewBiomeGenBase.river.biomeID && k1 != NewBiomeGenBase.swampland.biomeID && k1 != NewBiomeGenBase.extremeHills.biomeID) {
            ...
            } else if (k1 == NewBiomeGenBase.extremeHills.biomeID) {
