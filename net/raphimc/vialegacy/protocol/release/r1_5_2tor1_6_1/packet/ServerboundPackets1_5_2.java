...
public enum ServerboundPackets1_5_2 implements ServerboundPacketType, PreNettyPacketType {
   ...
   public static ServerboundPackets1_5_2 getPacket(int id) {
      return REGISTRY[id];
   }

   private ServerboundPackets1_5_2(int id, BiConsumer packetReader) {
      this.id = id;
