...
public enum ClientboundPackets1_5_2 implements ClientboundPacketType, PreNettyPacketType {
   ...
   private static final ClientboundPackets1_5_2[] REGISTRY = new ClientboundPackets1_5_2[256];
   private final int id;
   private final BiConsumer packetReader;

   public static ClientboundPackets1_5_2 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPackets1_5_2(int id, BiConsumer packetReader) {
      this.id = id;
