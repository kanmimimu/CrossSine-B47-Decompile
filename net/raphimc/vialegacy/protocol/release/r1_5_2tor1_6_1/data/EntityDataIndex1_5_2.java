...
public enum EntityDataIndex1_5_2 {
   ...
   private static Optional getIndex(EntityTypes1_8.EntityType type, int index) {
      ...
      return Optional.ofNullable((EntityDataIndex1_5_2)ENTITY_DATA_REWRITES.get(pair));
   }
   ...
   public static EntityDataIndex1_5_2 searchIndex(EntityTypes1_8.EntityType type, int index) {
      ...
      do {
         ...
         if (optMeta.isPresent()) {
            return (EntityDataIndex1_5_2)optMeta.get();
         }
   ...
   // $FF: synthetic method
   private static EntityDataIndex1_5_2[] $values() {
      return new EntityDataIndex1_5_2[]{ENTITY_LIVING_POTION_EFFECT_COLOR, ENTITY_LIVING_IS_POTION_EFFECT_AMBIENT, ENTITY_LIVING_ARROWS, ENTITY_LIVING_NAME_TAG, ENTITY_LIVING_NAME_TAG_VISIBILITY, HUMAN_ABSORPTION_HEARTS, BOAT_DAMAGE_TAKEN, MINECART_DAMAGE_TAKEN, WITHER_HEALTH, ENDER_DRAGON_HEALTH, WOLF_HEALTH};
   }

   static {
      for(EntityDataIndex1_5_2 index : values()) {
