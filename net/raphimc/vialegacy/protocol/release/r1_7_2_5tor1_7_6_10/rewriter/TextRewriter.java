...
public class TextRewriter {
   private static final Object2ObjectMap TRANSLATIONS = new Object2ObjectOpenHashMap(86, 0.99F);

   public static String toClient(String text) {
      ATextComponent component = TextComponentSerializer.V1_7.deserialize(text);
