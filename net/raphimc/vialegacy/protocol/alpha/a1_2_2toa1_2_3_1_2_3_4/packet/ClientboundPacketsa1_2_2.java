...
public enum ClientboundPacketsa1_2_2 implements ClientboundPacketType, PreNettyPacketType {
   ...
   public static ClientboundPacketsa1_2_2 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPacketsa1_2_2(int id, BiConsumer packetReader) {
      this.id = id;
   ...
   // $FF: synthetic method
   private static ClientboundPacketsa1_2_2[] $values() {
      return new ClientboundPacketsa1_2_2[]{KEEP_ALIVE, LOGIN, HANDSHAKE, CHAT, SET_TIME, PLAYER_INVENTORY, SET_DEFAULT_SPAWN_POSITION, MOVE_PLAYER_STATUS_ONLY, MOVE_PLAYER_POS, MOVE_PLAYER_ROT, PLAYER_POSITION, SET_CARRIED_ITEM, ADD_TO_INVENTORY, ANIMATE, ADD_PLAYER, SPAWN_ITEM, TAKE_ITEM_ENTITY, ADD_ENTITY, ADD_MOB, SET_ENTITY_MOTION, REMOVE_ENTITIES, MOVE_ENTITY, MOVE_ENTITY_POS, MOVE_ENTITY_ROT, MOVE_ENTITY_POS_ROT, TELEPORT_ENTITY, SET_ENTITY_LINK, PRE_CHUNK, LEVEL_CHUNK, CHUNK_BLOCKS_UPDATE, BLOCK_UPDATE, BLOCK_ENTITY_DATA, DISCONNECT};
   }
