...
public enum ClientboundPacketsa1_2_0 implements ClientboundPacketType, PreNettyPacketType {
   ...
   public static ClientboundPacketsa1_2_0 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPacketsa1_2_0(int id, BiConsumer packetReader) {
      this.id = id;
