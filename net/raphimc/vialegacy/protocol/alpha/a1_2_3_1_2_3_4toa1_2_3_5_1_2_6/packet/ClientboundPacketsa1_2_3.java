...
public enum ClientboundPacketsa1_2_3 implements ClientboundPacketType, PreNettyPacketType {
   ...
   private ClientboundPacketsa1_2_3(int id, BiConsumer packetReader) {
      this.id = id;
