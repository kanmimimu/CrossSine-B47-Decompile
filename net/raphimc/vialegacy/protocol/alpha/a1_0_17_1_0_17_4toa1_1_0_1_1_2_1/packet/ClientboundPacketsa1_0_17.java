...
public enum ClientboundPacketsa1_0_17 implements ClientboundPacketType, PreNettyPacketType {
   ...
   public static ClientboundPacketsa1_0_17 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPacketsa1_0_17(int id, BiConsumer packetReader) {
      this.id = id;
