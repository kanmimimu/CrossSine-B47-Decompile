...
public enum ServerboundPacketsa1_0_17 implements ServerboundPacketType, PreNettyPacketType {
   ...
   public static ServerboundPacketsa1_0_17 getPacket(int id) {
      return REGISTRY[id];
   }

   private ServerboundPacketsa1_0_17(int id, BiConsumer packetReader) {
      this.id = id;
   ...
   // $FF: synthetic method
   private static ServerboundPacketsa1_0_17[] $values() {
      return new ServerboundPacketsa1_0_17[]{KEEP_ALIVE, LOGIN, HANDSHAKE, CHAT, MOVE_PLAYER_STATUS_ONLY, MOVE_PLAYER_POS, MOVE_PLAYER_ROT, MOVE_PLAYER_POS_ROT, PLAYER_ACTION, USE_ITEM_ON, SET_CARRIED_ITEM, SWING, SPAWN_ITEM, DISCONNECT};
   }
