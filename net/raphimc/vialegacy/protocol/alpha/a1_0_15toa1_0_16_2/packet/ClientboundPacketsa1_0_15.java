...
public enum ClientboundPacketsa1_0_15 implements ClientboundPacketType, PreNettyPacketType {
   ...
   public static ClientboundPacketsa1_0_15 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPacketsa1_0_15(int id, BiConsumer packetReader) {
      this.id = id;
   ...
   // $FF: synthetic method
   private static ClientboundPacketsa1_0_15[] $values() {
      return new ClientboundPacketsa1_0_15[]{KEEP_ALIVE, LOGIN, CHAT, MOVE_PLAYER_STATUS_ONLY, MOVE_PLAYER_POS, MOVE_PLAYER_ROT, PLAYER_POSITION, SET_CARRIED_ITEM, ADD_TO_INVENTORY, ANIMATE, ADD_PLAYER, SPAWN_ITEM, TAKE_ITEM_ENTITY, ADD_ENTITY, REMOVE_ENTITIES, MOVE_ENTITY, MOVE_ENTITY_POS, MOVE_ENTITY_ROT, MOVE_ENTITY_POS_ROT, TELEPORT_ENTITY, PRE_CHUNK, LEVEL_CHUNK, CHUNK_BLOCKS_UPDATE, BLOCK_UPDATE, DISCONNECT};
   }
