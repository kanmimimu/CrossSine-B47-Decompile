...
public class AlphaItems {
   ...
   private static final Int2ObjectMap INTERACT_ACTION = new Int2ObjectOpenHashMap(14, 0.99F);
   private static final Int2ObjectMap PLACE_ACTION = new Int2ObjectOpenHashMap(15, 0.99F);
   ...
   public static void doInteract(Item item) {
      ((Consumer)INTERACT_ACTION.get(item.identifier())).accept(item);
   }

   public static void doPlace(Item item, short direction, IdAndData placedAgainst) {
      ((BiConsumer)PLACE_ACTION.get(item.identifier())).accept(item, new IntObjectImmutablePair(direction, placedAgainst));
   }
   ...
   static {
      ...
      INTERACT_ACTION.defaultReturnValue(Item::identifier);
      INTERACT_ACTION.put(260, (Consumer)(i) -> i.setAmount(i.amount() - 1));
      INTERACT_ACTION.put(297, (Consumer)(i) -> i.setAmount(i.amount() - 1));
      INTERACT_ACTION.put(319, (Consumer)(i) -> i.setAmount(i.amount() - 1));
      INTERACT_ACTION.put(320, (Consumer)(i) -> i.setAmount(i.amount() - 1));
      INTERACT_ACTION.put(322, (Consumer)(i) -> i.setAmount(i.amount() - 1));
      INTERACT_ACTION.put(326, (Consumer)(i) -> i.setIdentifier(325));
      INTERACT_ACTION.put(327, (Consumer)(i) -> i.setIdentifier(325));
      INTERACT_ACTION.put(332, (Consumer)(i) -> i.setAmount(i.amount() - 1));
      INTERACT_ACTION.put(333, (Consumer)(i) -> i.setAmount(i.amount() - 1));
      INTERACT_ACTION.put(335, (Consumer)(i) -> i.setIdentifier(325));
      INTERACT_ACTION.put(346, (Consumer)(i) -> {
      ...
      INTERACT_ACTION.put(349, (Consumer)(i) -> i.setAmount(i.amount() - 1));
      INTERACT_ACTION.put(350, (Consumer)(i) -> i.setAmount(i.amount() - 1));
      INTERACT_ACTION.put(282, (Consumer)(i) -> {
         i.setIdentifier(281);
         i.setAmount(1);
         i.setData((short)0);
      });
      PLACE_ACTION.defaultReturnValue((BiConsumer)(i, d) -> i.identifier());
      PLACE_ACTION.put(259, (BiConsumer)(i, d) -> {
         i.setData((short)(i.data() + 1));
         if (i.data() > 64) {
            i.setAmount(i.amount() - 1);
         }
      ...
      PLACE_ACTION.put(290, (BiConsumer)(i, d) -> {
         if (((IdAndData)d.value()).getId() == BlockList1_6.grass.blockId() || ((IdAndData)d.value()).getId() == BlockList1_6.dirt.blockId()) {
            i.setData((short)(i.data() + 1));
            if (i.data() > 32) {
               i.setAmount(i.amount() - 1);
            }
      ...
      PLACE_ACTION.put(291, (BiConsumer)(i, d) -> {
         if (((IdAndData)d.value()).getId() == BlockList1_6.grass.blockId() || ((IdAndData)d.value()).getId() == BlockList1_6.dirt.blockId()) {
            i.setData((short)(i.data() + 1));
            if (i.data() > 64) {
               i.setAmount(i.amount() - 1);
      ...
      PLACE_ACTION.put(292, (BiConsumer)(i, d) -> {
         if (((IdAndData)d.value()).getId() == BlockList1_6.grass.blockId() || ((IdAndData)d.value()).getId() == BlockList1_6.dirt.blockId()) {
            i.setData((short)(i.data() + 1));
            if (i.data() > 128) {
               i.setAmount(i.amount() - 1);
      ...
      PLACE_ACTION.put(293, (BiConsumer)(i, d) -> {
         if (((IdAndData)d.value()).getId() == BlockList1_6.grass.blockId() || ((IdAndData)d.value()).getId() == BlockList1_6.dirt.blockId()) {
            i.setData((short)(i.data() + 1));
            if (i.data() > 256) {
               i.setAmount(i.amount() - 1);
      ...
      PLACE_ACTION.put(294, (BiConsumer)(i, d) -> {
         if (((IdAndData)d.value()).getId() == BlockList1_6.grass.blockId() || ((IdAndData)d.value()).getId() == BlockList1_6.dirt.blockId()) {
            i.setData((short)(i.data() + 1));
            if (i.data() > 64) {
               i.setAmount(i.amount() - 1);
      ...
      PLACE_ACTION.put(295, (BiConsumer)(i, d) -> {
         if (d.keyInt() == 1 && ((IdAndData)d.value()).getId() == BlockList1_6.tilledField.blockId()) {
            i.setAmount(i.amount() - 1);
         }

      });
      PLACE_ACTION.put(321, (BiConsumer)(i, d) -> {
         if (d.keyInt() != 0 && d.keyInt() != 1) {
            i.setAmount(i.amount() - 1);
         }

      });
      PLACE_ACTION.put(324, (BiConsumer)(i, d) -> {
         if (d.keyInt() == 1) {
            i.setAmount(i.amount() - 1);
         }

      });
      PLACE_ACTION.put(328, (BiConsumer)(i, d) -> {
         if (((IdAndData)d.value()).getId() == BlockList1_6.rail.blockId()) {
            i.setAmount(i.amount() - 1);
         }

      });
      PLACE_ACTION.put(330, (BiConsumer)(i, d) -> {
         if (d.keyInt() == 1) {
            i.setAmount(i.amount() - 1);
         }

      });
      PLACE_ACTION.put(342, (BiConsumer)(i, d) -> {
         if (((IdAndData)d.value()).getId() == BlockList1_6.rail.blockId()) {
            i.setAmount(i.amount() - 1);
         }

      });
      PLACE_ACTION.put(343, (BiConsumer)(i, d) -> {
         if (((IdAndData)d.value()).getId() == BlockList1_6.rail.blockId()) {
            i.setAmount(i.amount() - 1);
         }

      });
      PLACE_ACTION.put(2256, (BiConsumer)(i, d) -> {
         if (((IdAndData)d.value()).getId() == BlockList1_6.jukebox.blockId() && ((IdAndData)d.value()).getData() == 0) {
            i.setAmount(i.amount() - 1);
         }

      });
      PLACE_ACTION.put(2257, (BiConsumer)(i, d) -> {
         if (((IdAndData)d.value()).getId() == BlockList1_6.jukebox.blockId() && ((IdAndData)d.value()).getData() == 0) {
            i.setAmount(i.amount() - 1);
         }
