...
public enum ServerboundPacketsa1_2_6 implements ServerboundPacketType, PreNettyPacketType {
   ...
   public static ServerboundPacketsa1_2_6 getPacket(int id) {
      return REGISTRY[id];
   }

   private ServerboundPacketsa1_2_6(int id, BiConsumer packetReader) {
      this.id = id;
   ...
   // $FF: synthetic method
   private static ServerboundPacketsa1_2_6[] $values() {
      return new ServerboundPacketsa1_2_6[]{KEEP_ALIVE, LOGIN, HANDSHAKE, CHAT, PLAYER_INVENTORY, INTERACT, RESPAWN, MOVE_PLAYER_STATUS_ONLY, MOVE_PLAYER_POS, MOVE_PLAYER_ROT, MOVE_PLAYER_POS_ROT, PLAYER_ACTION, USE_ITEM_ON, SET_CARRIED_ITEM, SWING, SPAWN_ITEM, BLOCK_ENTITY_DATA, DISCONNECT};
   }
