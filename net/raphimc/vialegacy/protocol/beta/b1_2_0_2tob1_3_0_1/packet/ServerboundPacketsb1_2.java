...
public enum ServerboundPacketsb1_2 implements ServerboundPacketType, PreNettyPacketType {
   ...
   public static ServerboundPacketsb1_2 getPacket(int id) {
      return REGISTRY[id];
   }

   private ServerboundPacketsb1_2(int id, BiConsumer packetReader) {
      this.id = id;
   ...
   // $FF: synthetic method
   private static ServerboundPacketsb1_2[] $values() {
      return new ServerboundPacketsb1_2[]{KEEP_ALIVE, LOGIN, HANDSHAKE, CHAT, INTERACT, RESPAWN, MOVE_PLAYER_STATUS_ONLY, MOVE_PLAYER_POS, MOVE_PLAYER_ROT, MOVE_PLAYER_POS_ROT, PLAYER_ACTION, USE_ITEM_ON, SET_CARRIED_ITEM, SWING, PLAYER_COMMAND, CONTAINER_CLOSE, CONTAINER_CLICK, CONTAINER_ACK, SIGN_UPDATE, DISCONNECT};
   }
