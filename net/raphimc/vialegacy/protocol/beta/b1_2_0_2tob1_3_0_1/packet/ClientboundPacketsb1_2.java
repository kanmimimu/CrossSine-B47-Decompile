...
public enum ClientboundPacketsb1_2 implements ClientboundPacketType, PreNettyPacketType {
   ...
   public static ClientboundPacketsb1_2 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPacketsb1_2(int id, BiConsumer packetReader) {
      this.id = id;
