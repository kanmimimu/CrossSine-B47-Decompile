...
public enum ClientboundPacketsb1_4 implements ClientboundPacketType, PreNettyPacketType {
   ...
   public static ClientboundPacketsb1_4 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPacketsb1_4(int id, BiConsumer packetReader) {
      this.id = id;
