...
public enum ServerboundPacketsb1_4 implements ServerboundPacketType, PreNettyPacketType {
   ...
   private ServerboundPacketsb1_4(int id, BiConsumer packetReader) {
      this.id = id;
   ...
   // $FF: synthetic method
   private static ServerboundPacketsb1_4[] $values() {
      return new ServerboundPacketsb1_4[]{KEEP_ALIVE, LOGIN, HANDSHAKE, CHAT, INTERACT, RESPAWN, MOVE_PLAYER_STATUS_ONLY, MOVE_PLAYER_POS, MOVE_PLAYER_ROT, MOVE_PLAYER_POS_ROT, PLAYER_ACTION, USE_ITEM_ON, SET_CARRIED_ITEM, SWING, PLAYER_COMMAND, POSITION, CONTAINER_CLOSE, CONTAINER_CLICK, CONTAINER_ACK, SIGN_UPDATE, DISCONNECT};
   }
