...
public enum ClientboundPacketsb1_5 implements ClientboundPacketType, PreNettyPacketType {
   ...
   public static ClientboundPacketsb1_5 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPacketsb1_5(int id, BiConsumer packetReader) {
      this.id = id;
