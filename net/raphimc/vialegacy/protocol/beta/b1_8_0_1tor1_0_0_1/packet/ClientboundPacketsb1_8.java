...
public enum ClientboundPacketsb1_8 implements ClientboundPacketType, PreNettyPacketType {
   ...
   public static ClientboundPacketsb1_8 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPacketsb1_8(int id, BiConsumer packetReader) {
      this.id = id;
