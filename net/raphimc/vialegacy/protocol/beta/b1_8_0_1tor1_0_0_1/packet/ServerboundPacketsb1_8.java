...
public enum ServerboundPacketsb1_8 implements ServerboundPacketType, PreNettyPacketType {
   ...
   private ServerboundPacketsb1_8(int id, BiConsumer packetReader) {
      this.id = id;
   ...
   // $FF: synthetic method
   private static ServerboundPacketsb1_8[] $values() {
      return new ServerboundPacketsb1_8[]{KEEP_ALIVE, LOGIN, HANDSHAKE, CHAT, INTERACT, RESPAWN, MOVE_PLAYER_STATUS_ONLY, MOVE_PLAYER_POS, MOVE_PLAYER_ROT, MOVE_PLAYER_POS_ROT, PLAYER_ACTION, USE_ITEM_ON, SET_CARRIED_ITEM, SWING, PLAYER_COMMAND, POSITION, CONTAINER_CLOSE, CONTAINER_CLICK, CONTAINER_ACK, SET_CREATIVE_MODE_SLOT, SIGN_UPDATE, SERVER_PING, DISCONNECT};
   }
