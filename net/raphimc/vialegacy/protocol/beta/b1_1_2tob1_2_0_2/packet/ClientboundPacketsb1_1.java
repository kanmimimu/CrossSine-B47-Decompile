...
public enum ClientboundPacketsb1_1 implements ClientboundPacketType, PreNettyPacketType {
   ...
   public static ClientboundPacketsb1_1 getPacket(int id) {
      return REGISTRY[id];
   }

   private ClientboundPacketsb1_1(int id, BiConsumer packetReader) {
      this.id = id;
