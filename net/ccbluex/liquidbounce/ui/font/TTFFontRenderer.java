...
public class TTFFontRenderer {
   ...
   public void drawOutlineStringWithoutGL(String s, float x, float y, int color, FontRenderer fontRenderer) {
      fontRenderer.func_78276_b(ColorUtils.stripColor(s), (int)(x * 2.0F - 1.0F), (int)(y * 2.0F), Color.BLACK.getRGB());
      fontRenderer.func_78276_b(ColorUtils.stripColor(s), (int)(x * 2.0F + 1.0F), (int)(y * 2.0F), Color.BLACK.getRGB());
      fontRenderer.func_78276_b(ColorUtils.stripColor(s), (int)(x * 2.0F), (int)(y * 2.0F - 1.0F), Color.BLACK.getRGB());
      fontRenderer.func_78276_b(ColorUtils.stripColor(s), (int)(x * 2.0F), (int)(y * 2.0F + 1.0F), Color.BLACK.getRGB());
      fontRenderer.func_78276_b(s, (int)(x * 2.0F), (int)(y * 2.0F), color);
   }
   ...
   public void drawStringWithShadow(String text, float x, float y, int color) {
      GL11.glTranslated((double)0.5F, (double)0.5F, (double)0.0F);
   ...
   private void renderString(String text, float x, float y, int color, boolean shadow) {
      if (text.length() != 0) {
         GL11.glPushMatrix();
         GlStateManager.func_179139_a((double)0.5F, (double)0.5F, (double)1.0F);
         x -= 2.0F;
         y -= 2.0F;
         x += 0.5F;
         y += 0.5F;
            ...
            if (previous != 167) {
               if (character == 167 && i < length) {
                  ...
                  if (index < 16) {
                     ...
                     GL11.glColor4d((double)(textColor >> 16) / (double)255.0F, (double)(textColor >> 8 & 255) / (double)255.0F, (double)(textColor & 255) / (double)255.0F, (double)a);
                  } else if (index == 16) {
                     obfuscated = true;
                  } else if (index == 17) {
                     ...
                     underlined = false;
                     characterData = this.regularData;
                     GL11.glColor4d((double)1.0F * (shadow ? (double)0.25F : (double)1.0F), (double)1.0F * (shadow ? (double)0.25F : (double)1.0F), (double)1.0F * (shadow ? (double)0.25F : (double)1.0F), (double)a);
                  }
