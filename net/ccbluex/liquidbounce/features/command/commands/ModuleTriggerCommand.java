...
@Metadata(
   ...
   d2 = {"Lnet/ccbluex/liquidbounce/features/command/commands/ModuleTriggerCommand;", "Lnet/ccbluex/liquidbounce/features/command/Command;", "()V", "modes", "", "", "[Ljava/lang/String;", "execute", "", "args", "([Ljava/lang/String;)V", "tabComplete", "", "([Ljava/lang/String;)Ljava/util/List;", "CrossSine"}
)
public final class ModuleTriggerCommand extends Command {
   ...
   public ModuleTriggerCommand() {
      String[] thisCollection$iv = new String[]{"trigger"};
      super("moduletrigger", thisCollection$iv);
      EnumTriggerType[] $this$toTypedArray$iv = EnumTriggerType.values();
      int $i$f$map = 0;
      Collection destination$iv$iv = (Collection)(new ArrayList($this$toTypedArray$iv.length));
      int $i$f$mapTo = 0;
      EnumTriggerType[] var6 = $this$toTypedArray$iv;
      int var7 = 0;
      ...
      while(var7 < var8) {
         ...
         ++var7;
         int var11 = 0;
         String var12 = ((EnumTriggerType)item$iv$iv).name().toLowerCase(Locale.ROOT);
      ...
      if (args.length > 2) {
         ...
         if (module == null) {
            ...
            try {
               ...
               var3 = EnumTriggerType.valueOf(var4);
            } catch (IllegalArgumentException var6) {
               var10000 = module;
               var3 = EnumTriggerType.TOGGLE;
            }

            var10000.setTriggerType(var3);
            this.playEdit();
            this.alert("Set module §l" + module.getName() + "§r trigger type to §l" + module.getTriggerType() + "§r.");
         }
      } else {
         this.chatSyntax("moduletrigger <module> [" + StringUtils.toCompleteString(this.modes, 0, ",") + ']');
      }
   }
