...
@Metadata(
   ...
   d2 = {"Lnet/ccbluex/liquidbounce/features/command/commands/FakeNameCommand;", "Lnet/ccbluex/liquidbounce/features/command/Command;", "()V", "execute", "", "args", "", "", "([Ljava/lang/String;)V", "tabComplete", "", "([Ljava/lang/String;)Ljava/util/List;", "CrossSine"}
)
public final class FakeNameCommand extends Command {
   public FakeNameCommand() {
      int $i$f$emptyArray = 0;
      super("SetFakeName", new String[0]);
   }

   public void execute(@NotNull String[] args) {
      Intrinsics.checkNotNullParameter(args, "args");
      if (args.length > 2) {
         Module var10000 = CrossSine.INSTANCE.getModuleManager().getModule(args[1]);
         if (var10000 == null) {
            return;
         }
         ...
         this.chatSyntax("SetFakeName <Module> <Name>");
      }
