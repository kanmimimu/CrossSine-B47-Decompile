...
@Metadata(
   ...
   d2 = {"Lnet/ccbluex/liquidbounce/features/command/commands/DamageCommand;", "Lnet/ccbluex/liquidbounce/features/command/Command;", "()V", "execute", "", "args", "", "", "([Ljava/lang/String;)V", "CrossSine"}
)
public final class DamageCommand extends Command {
   public DamageCommand() {
      String[] var1 = new String[]{"hurt"};
      super("damage", var1);
   }
