...
@Metadata(
   ...
   d2 = {"Lnet/ccbluex/liquidbounce/features/command/commands/IgnCommand;", "Lnet/ccbluex/liquidbounce/features/command/Command;", "()V", "execute", "", "args", "", "", "([Ljava/lang/String;)V", "CrossSine"}
)
public final class IgnCommand extends Command {
   public IgnCommand() {
