...
public final class JumpFlight extends FlightMode {
   ...
   public final void onBB(@NotNull BlockBBEvent event) {
      ...
      event.setBoundingBox(AxisAlignedBB.func_178781_a((double)event.getX(), (double)event.getY(), (double)event.getZ(), (double)(event.getX() + 1), this.startY, (double)(event.getZ() + 1)));
   }
}
