...
public final class BlocksMCNoSlow extends NoSlowMode {
   ...
   public void onPreMotion(@NotNull MotionEvent event) {
      ...
      if (this.getHoldConsume() && MinecraftInstance.mc.field_71439_g.func_71039_bw() || this.getHoldBow() && MinecraftInstance.mc.field_71439_g.func_71039_bw()) {
         int var2 = this.tickCycle++;
         if (this.tickCycle == 1) {
            ...
            PacketUtils.sendPacketNoEvent((Packet)(new C08PacketPlayerBlockPlacement(new BlockPos(-1, -1, -1), 0, MinecraftInstance.mc.field_71439_g.func_70694_bm(), 0.0F, 0.0F, 0.0F)));
         }
      } else {
         this.tickCycle = 0;
      }
