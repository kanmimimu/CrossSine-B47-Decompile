...
public final class MatrixCollideNofall extends NoFallMode {
   ...
   public void onNoFall(@NotNull UpdateEvent event) {
      ...
      if ((double)((int)MinecraftInstance.mc.field_71439_g.field_70143_R) - MinecraftInstance.mc.field_71439_g.field_70181_x > (double)3.0F) {
         ...
         var2.field_70159_w *= 0.1;
         var2 = MinecraftInstance.mc.field_71439_g;
         var2.field_70179_y *= 0.1;
         this.needSpoof = true;
      }
