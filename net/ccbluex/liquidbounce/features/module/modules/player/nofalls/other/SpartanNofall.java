...
public final class SpartanNofall extends NoFallMode {
   @NotNull
   ...
   public void onNoFall(@NotNull UpdateEvent event) {
      ...
      if ((double)MinecraftInstance.mc.field_71439_g.field_70143_R > (double)1.5F && this.spartanTimer.hasTimePassed(10)) {
