...
public class Colors {
   ...
   public static Color astolfoRainbow(int delay, int offset, int index) {
      ...
      double var5;
      return Color.getHSBColor((double)((float)((var5 = rainbowDelay % (double)360.0F) / (double)360.0F)) < (double)0.5F ? -((float)(var5 / (double)360.0F)) : (float)(var5 / (double)360.0F), 0.5F, 1.0F);
   }
