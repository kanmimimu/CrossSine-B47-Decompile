...
public abstract class AnimationUnit {
   ...
   public AnimationUnit(int ms, double endPoint) {
      this.duration = ms;
      this.endPoint = endPoint;
      this.direction = Direction.FORWARDS;
   }

   public AnimationUnit(int ms, double endPoint, Direction direction) {
      this.duration = ms;
      this.endPoint = endPoint;
   ...
   public double getOutput() {
      if (this.direction == Direction.FORWARDS) {
         ...
         return ((double)1.0F - this.getEquation((double)this.timerUtil.getTime())) * this.endPoint;
      }
   }
