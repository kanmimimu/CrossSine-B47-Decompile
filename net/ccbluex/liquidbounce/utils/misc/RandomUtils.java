...
public final class RandomUtils {
   ...
   @NotNull
   private static final Map leetMap;
   @NotNull
   ...
   public final double nextDouble(double startInclusive, double endInclusive) {
      return startInclusive != endInclusive && !(endInclusive - startInclusive <= (double)0.0F) ? startInclusive + (endInclusive - startInclusive) * Math.random() : startInclusive;
   }
   ...
   private final String randomString(int length, String chars) {
      ...
      while(var4 < length) {
         ++var4;
         Random var10002 = random;
         char[] var6 = chars.toCharArray();
         Intrinsics.checkNotNullExpressionValue(var6, "this as java.lang.String).toCharArray()");
         stringBuilder.append(chars.charAt(var10002.nextInt(var6.length)));
      }

      String var7 = stringBuilder.toString();
      Intrinsics.checkNotNullExpressionValue(var7, "stringBuilder.toString()");
      return var7;
   }
   ...
   public final String randomUsername(int maxLength, boolean raw) {
      if (!GuiAltManager.Companion.getStylisedAlts()) {
         ...
         String animal = null;
         if (this.nextBoolean()) {
            Object[] $this$filter$iv = ADJECTIVES;
            int $i$f$filter = 0;
            Collection destination$iv$iv = (Collection)(new ArrayList());
            int $i$f$filterTo = 0;
            Object var10 = $this$filter$iv;
            int var11 = 0;
            int var12 = $this$filter$iv.length;

            while(var11 < var12) {
               Object element$iv$iv = ((Object[])var10)[var11];
               ++var11;
               int var15 = 0;
               if (((String)element$iv$iv).length() <= maxLength - 3) {
                  destination$iv$iv.add(element$iv$iv);
               }
            }

            adjective = (String)CollectionsKt.random((Collection)((List)destination$iv$iv), kotlin.random.Random.Default);
            $this$filter$iv = ANIMALS;
            $i$f$filter = 0;
            destination$iv$iv = (Collection)(new ArrayList());
            $i$f$filterTo = 0;
            var10 = $this$filter$iv;
            var11 = 0;
            var12 = $this$filter$iv.length;

            while(var11 < var12) {
               Object element$iv$iv = ((Object[])var10)[var11];
               ++var11;
               int var44 = 0;
               if (((String)element$iv$iv).length() <= maxLength - adjective.length()) {
                  destination$iv$iv.add(element$iv$iv);
               }
            }

            animal = (String)CollectionsKt.random((Collection)((List)destination$iv$iv), kotlin.random.Random.Default);
         } else {
            Object[] $this$filter$iv = ANIMALS;
            int $i$f$filter = 0;
            Collection destination$iv$iv = (Collection)(new ArrayList());
            int $i$f$filterTo = 0;
            Object var33 = $this$filter$iv;
            int var36 = 0;
            int var39 = $this$filter$iv.length;

            while(var36 < var39) {
               Object element$iv$iv = ((Object[])var33)[var36];
               ++var36;
               int var45 = 0;
               if (((String)element$iv$iv).length() <= maxLength - 3) {
                  destination$iv$iv.add(element$iv$iv);
            ...
            destination$iv$iv = (Collection)(new ArrayList());
            $i$f$filterTo = 0;
            var33 = $this$filter$iv;
            var36 = 0;
            var39 = $this$filter$iv.length;

            while(var36 < var39) {
               Object element$iv$iv = ((Object[])var33)[var36];
               ++var36;
               int var46 = 0;
               if (((String)element$iv$iv).length() <= maxLength - animal.length()) {
                  destination$iv$iv.add(element$iv$iv);
               }
            }
         ...
         if (!raw) {
            ...
            String baseName = this.leetRandomly(adjective) + (adjective.length() + animal.length() < maxLength ? this.random(1, (String)"0123456789_") : "") + this.leetRandomly(animal);
            int fillerCount = maxLength - baseName.length();
            String $this$filterTo$iv$iv = (new StringBuilder(this.random(fillerCount, "0123456789_"))).insert(nextInt(0, fillerCount), baseName).toString();
            Intrinsics.checkNotNullExpressionValue($this$filterTo$iv$iv, "StringBuilder(random(fil…nt), baseName).toString()");
   ...
   // $FF: synthetic method
   public static String randomUsername$default(RandomUtils var0, int var1, boolean var2, int var3, Object var4) {
      if ((var3 & 1) != 0) {
         var1 = GuiAltManager.Companion.getAltsLength();
      }

      if ((var3 & 2) != 0) {
         var2 = GuiAltManager.Companion.getUnformattedAlts();
      }

      return var0.randomUsername(var1, var2);
   }

   private final String leetRandomly(String string) {
      CharSequence $this$mapIndexed$iv = (CharSequence)string;
      int $i$f$mapIndexed = 0;
      Collection destination$iv$iv = (Collection)(new ArrayList($this$mapIndexed$iv.length()));
      int $i$f$mapIndexedTo = 0;
      int index$iv$iv = 0;
      CharSequence var8 = $this$mapIndexed$iv;

      Object var10000;
      for(int var9 = 0; var9 < var8.length(); destination$iv$iv.add(var10000)) {
         char item$iv$iv = var8.charAt(var9);
         ++var9;
         int var11 = index$iv$iv++;
         int var14 = 0;
         if (var11 != 0 && var11 != StringsKt.getLastIndex((CharSequence)string) && INSTANCE.nextBoolean()) {
            Map var17 = leetMap;
            String var15 = String.valueOf(item$iv$iv).toLowerCase(Locale.ROOT);
            Intrinsics.checkNotNullExpressionValue(var15, "this as java.lang.String).toLowerCase(Locale.ROOT)");
            var10000 = (String)var17.get(var15);
            if (var10000 == null) {
               var10000 = item$iv$iv;
            }
         } else {
