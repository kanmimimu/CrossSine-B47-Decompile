...
@Metadata(
   ...
   d2 = {"Lnet/ccbluex/liquidbounce/event/StrafeEvent;", "Lnet/ccbluex/liquidbounce/event/CancellableEvent;", "strafe", "", "forward", "friction", "yaw", "(FFFF)V", "getForward", "()F", "getFriction", "getStrafe", "getYaw", "setYaw", "(F)V", "CrossSine"}
)
