...
@Metadata(
   ...
   d2 = {"Lme/liuli/elixir/account/CrackedAccount;", "Lme/liuli/elixir/account/MinecraftAccount;", "()V", "name", "", "getName", "()Ljava/lang/String;", "setName", "(Ljava/lang/String;)V", "session", "Lme/liuli/elixir/compat/Session;", "getSession", "()Lme/liuli/elixir/compat/Session;", "fromRawJson", "", "json", "Lcom/google/gson/JsonObject;", "toRawJson", "update", "Elixir"}
)
public final class CrackedAccount extends MinecraftAccount {
   ...
   public Session getSession() {
      ...
      byte[] var2 = this.getName().getBytes(Charsets.UTF_8);
      Intrinsics.checkNotNullExpressionValue(var2, "this as java.lang.String).getBytes(charset)");
      String var1 = UUID.nameUUIDFromBytes(var2).toString();
      Intrinsics.checkNotNullExpressionValue(var1, "nameUUIDFromBytes(name.t…arsets.UTF_8)).toString()");
      return new Session(var10002, var1, "-", "legacy");
   }
